...
## Corpus Check
- 223 files · ~4,050,061 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4893 nodes · 13520 edges · 329 communities (256 shown, 73 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 807 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `30bb9961`
...
## Communities (329 total, 73 thin omitted)
...
Cohesion: 0.02
Nodes (201): _$(), $4(), _5(), $8(), A4(), a5(), a7(), a8() (+193 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (181): abort(), args(), assert(), Au(), bd(), Bl(), bp(), brand() (+173 more)
...
Cohesion: 0.05
Nodes (87): a(), accept(), actionError(), allTextContents(), and(), array(), back(), bundle() (+79 more)

### Community 5 - "Community 5"
Cohesion: 0.04
Nodes (70): ChatResponse, CustomerProfile, DashboardStats, EscalationAlert, ExtractedEntity, ExtractionSource, OrderStatus, Pydantic schemas for API request/response validation. (+62 more)
...
Cohesion: 0.03
Nodes (66): create_new_ticket(), Create a new support ticket., cancel_order(), check_inventory(), create_ticket(), get_customer_by_id(), get_customer_history(), get_ticket() (+58 more)

### Community 8 - "Community 8"
Cohesion: 0.06
Nodes (68): aX(), bg(), Bk(), bM(), browserAuthSelector(), By(), clearPlaywrightFrameWorldsForTarget(), clearPlaywrightStateForTarget() (+60 more)
...
Cohesion: 0.09
Nodes (54): Aq(), Be(), browserName(), bt(), ca(), dE(), dj(), Eg() (+46 more)
...
Cohesion: 0.08
Nodes (51): actionError(), allTextContents(), and(), args(), cachedRead(), check(), clear(), click() (+43 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (48): TicketCreate, TicketResponse, TicketUpdate, admin_get_kb_doc(), admin_list_kb(), admin_reingest_kb(), admin_update_llm_settings(), cancel_order_endpoint() (+40 more)

### Community 15 - "Community 15"
Cohesion: 0.06
Nodes (46): bD(), bv(), cm(), createInventory(), currentTopLevelUrl(), deleteJsDialog(), dv(), En() (+38 more)
...
Cohesion: 0.07
Nodes (43): _addCheck(), base64(), base64url(), cidr(), cuid(), cuid2(), date(), datetime() (+35 more)

### Community 19 - "Community 19"
Cohesion: 0.11
Nodes (41): An(), callCdpTarget(), callRuntimeEvaluateInExecutionTarget(), callRuntimeEvaluateWithPlaywrightInjectedInTarget(), deletePlaywrightFrameWorld(), ds(), ensurePlaywrightInjectedInTarget(), evaluateOnPlaywrightPage() (+33 more)

### Community 20 - "Community 20"
Cohesion: 0.07
Nodes (43): adjustForFailure(), adjustForSuccess(), _attemptScheduledFlush(), batchSize(), _clearAllTimers(), containsAtLeastOneFullBatch(), convertPendingEventsToBatches(), createBatches() (+35 more)
...
Cohesion: 0.12
Nodes (30): WarrantyStatusResult, check_warranty_status(), _check_warranty_status_impl(), _parse_warranty_duration(), Deterministically parse warranty duration from product description., Deterministically parse warranty duration from product description., Deterministically check warranty status for a customer's purchase., Internal implementation of warranty check with DB retries. (+22 more)
...
Cohesion: 0.07
Nodes (38): _c(), dc(), dirty(), ea(), endsWith(), f(), Fc(), _getInvalidInput() (+30 more)

### Community 26 - "Community 26"
Cohesion: 0.07
Nodes (38): _addCheck(), append(), base64(), base64url(), cidr(), CL(), cuid(), cuid2() (+30 more)
...
Cohesion: 0.07
Nodes (37): Ag(), c0(), clearPollingTimer(), closeWatcher(), discoverRolloutPath(), dispose(), Fj(), fz() (+29 more)

### Community 29 - "Community 29"
Cohesion: 0.07
Nodes (36): add(), assertCanSetRequestHandler(), catchall(), convertBaseSchema(), convertSchema(), datetime(), describe(), detectVersion() (+28 more)
...
Cohesion: 0.09
Nodes (18): ProductSkillResolver, Deterministic skill resolution for the Product domain.     Python selects the sk, Deterministic skill resolution for the Product domain.      Delegates actual ski, Deterministic skill resolution for the Product domain.      Delegates actual ski, Deterministic skill resolution for the Product domain.      Delegates actual ski, Deterministic skill resolution for the Product domain.      Delegates actual ski, make_product_info_skill(), make_registry_with_product_skill() (+10 more)
...
Cohesion: 0.09
Nodes (32): addAttachment(), addScopeListener(), Ah(), bH(), BX(), dH(), dx(), enableDownload() (+24 more)

### Community 37 - "Community 37"
Cohesion: 0.09
Nodes (31): assertCompatibleLocator(), assertRequiredDocumentationRead(), bundle(), BW(), cI(), eb(), evaluateOnPlaywrightSelector(), exclude() (+23 more)
...
Cohesion: 0.07
Nodes (29): _execute_tool(), Execute a database tool by name, injecting the authenticated customer_id securel, Execute a database tool by name, injecting the authenticated customer_id securel, Execute a database tool by name, injecting the authenticated customer_id securel, Execute a database tool by name, injecting the authenticated customer_id securel, Execute a database tool by name, injecting the authenticated customer_id securel, Execute a database tool by name, injecting the authenticated customer_id securel, get_chat_history() (+21 more)
...
Cohesion: 0.15
Nodes (28): _capture(), captureCandidate(), commitCapture(), currentState(), DQ(), dU(), ensureTracked(), frameForId() (+20 more)

### Community 46 - "Community 46"
Cohesion: 0.12
Nodes (28): allowBeforeUnload(), attachedTabIdForCdpEvent(), Av(), callInputDispatch(), deleteJsDialogForTarget(), dispatchKeyPress(), Dl(), down() (+20 more)
...
Cohesion: 0.11
Nodes (27): A6(), aI(), array(), C6(), dirty(), _getInvalidInput(), _getOrReturnCtx(), _getType() (+19 more)

### Community 49 - "Community 49"
Cohesion: 0.1
Nodes (27): _7(), addToNumericResult(), b7(), Cs(), D7(), emitNamedEntityData(), emitNotTerminatedNamedEntity(), emitNumericEntity() (+19 more)

### Community 50 - "Community 50"
Cohesion: 0.09
Nodes (27): attach(), claimTab(), claimUserTab(), closeTab(), createTab(), detach(), detachTab(), detachTarget() (+19 more)
...
Cohesion: 0.14
Nodes (24): aD(), aK(), all(), bU(), describeBackendNodeForHitTarget(), eK(), eq(), eW() (+16 more)

### Community 59 - "Community 59"
Cohesion: 0.08
Nodes (24): b3(), CJ(), #e(), EJ(), getInfo(), hf(), identityForElement(), Jo() (+16 more)
...
Cohesion: 0.09
Nodes (23): addEventListener(), addListener(), addTabCleanupHandler(), bZ(), configureAndConnect(), connect(), constructor(), createNamespace() (+15 more)

### Community 63 - "Community 63"
Cohesion: 0.12
Nodes (22): activeRetiredInternalScreencastSessions(), da(), E3(), ensurePageAssetFallbackFetchAllowed(), ft(), ie(), keys(), lee() (+14 more)

### Community 64 - "Community 64"
Cohesion: 0.11
Nodes (22): addEvent(), addToPendingEventsQueue(), appendAndResetNonExposedChecks(), checkQuickFlush(), debug(), enqueue(), _getCurrentPageUrl(), _getEventsFromStorage() (+14 more)

### Community 65 - "Community 65"
Cohesion: 0.1
Nodes (22): assertFullCdpEnabled(), cre(), Fi(), fn(), fullCdpAccessState(), fv(), handleMessage(), isFullCdpEnabled() (+14 more)
...
Cohesion: 0.15
Nodes (21): attachDebuggerFrameTarget(), attachTarget(), deleteFrameSession(), detachAttachedFrameTargets(), documentation(), ensureRuntimeEnabled(), get(), getPath() (+13 more)
...
Cohesion: 0.11
Nodes (15): LLMAdapter, Product Agent (Phase D.1)  Owns product-domain reasoning. Receives semantic cont, # NOTE: This single-primary-tool pattern is temporary for the D.1 vertical slice, Protocol for LLM invocation — decouples ProductAgent from any specific provider., Protocol for LLM invocation — decouples ProductAgent from any specific provider., Protocol for LLM invocation — decouples ProductAgent from any specific provider., Protocol for LLM invocation — decouples ProductAgent from any specific provider., SkillExecutionResult (+7 more)
...
Cohesion: 0.17
Nodes (16): test_active_ticket_changed_order_creates(), test_active_ticket_compatible_intent_updates(), test_active_ticket_incompatible_intent_creates(), test_ambiguous_candidates_safe_behavior(), test_create_failure_returns_failed(), test_cross_customer_not_matched(), test_first_issue_creates(), test_lookup_failure_returns_failed() (+8 more)

### Community 73 - "Community 73"
Cohesion: 0.12
Nodes (20): $1(), CG(), d3(), endsWith(), ez(), Fee(), fX(), Iee() (+12 more)

### Community 74 - "Community 74"
Cohesion: 0.13
Nodes (20): error(), _fetchAndPrepFromNetwork(), _fetchFromNetwork(), _getCacheKey(), getContext(), _getDataAsyncImpl(), _getIsCacheValueValid(), _getSdkKey() (+12 more)

### Community 75 - "Community 75"
Cohesion: 0.17
Nodes (20): catch(), gA(), kd(), mg(), og(), oJ(), _onError(), PR() (+12 more)

### Community 76 - "Community 76"
Cohesion: 0.14
Nodes (20): C3(), cx(), dD(), ei(), fm(), G3(), HL(), ic() (+12 more)
...
Cohesion: 0.12
Nodes (19): AB(), Au(), ct(), fB(), Gz(), IB(), Iu(), IZ() (+11 more)

### Community 82 - "Community 82"
Cohesion: 0.15
Nodes (19): addBreadcrumb(), As(), Az(), b(), captureSession(), cz(), dz(), getEventProcessors() (+11 more)

### Community 83 - "Community 83"
Cohesion: 0.13
Nodes (19): aW(), call(), ck(), _configureUser(), dm(), ensureInterceptionReady(), eU(), evaluateJavascript() (+11 more)

### Community 84 - "Community 84"
Cohesion: 0.15
Nodes (19): AL(), cee(), EL(), g0(), Hn(), jte(), No(), on() (+11 more)
...
Cohesion: 0.16
Nodes (18): beacon(), close(), EP(), _getInternalRequestArgs(), _getPopulatedURL(), getUrl(), Gj(), handleBindingCall() (+10 more)

### Community 92 - "Community 92"
Cohesion: 0.18
Nodes (18): aA(), clickDomCuaNode(), clickLocator(), clickPoint(), dispatchCdpMouseRelease(), dispatchMouseDown(), dispatchMouseMove(), dispatchMouseUp() (+10 more)
...
Cohesion: 0.14
Nodes (17): a(), c(), ff(), format(), hasOwnedPausedResponses(), l(), Mo(), o() (+9 more)

### Community 95 - "Community 95"
Cohesion: 0.16
Nodes (17): AP(), eV(), fr(), iy(), kp(), mj(), Pp(), py() (+9 more)

### Community 96 - "Community 96"
Cohesion: 0.17
Nodes (17): buildRevision(), callTarget(), captureAX(), captureDocuments(), captureJavaScriptDialog(), captureSessions(), cY(), dispatchCdpMouseMove() (+9 more)
...
Cohesion: 0.21
Nodes (16): a0(), bB(), captureCheckIn(), CO(), cte(), getDsn(), getOptions(), getSdkMetadata() (+8 more)
...
Cohesion: 0.13
Nodes (16): A9(), E9(), G9(), instance(), J9(), ji(), K9(), logError() (+8 more)
...
Cohesion: 0.13
Nodes (13): list_customers(), Get all customers with pagination., get_all_customers(), Get all customers with pagination., Get all customers with pagination., Get all customers with pagination., Get all customers with pagination., Get all customers with pagination. (+5 more)

### Community 107 - "Community 107"
Cohesion: 0.2
Nodes (15): _clearOutcomes(), emit(), flush(), _flushOutcomes(), h0(), _isClientDoneProcessing(), jB(), _removeTrace() (+7 more)

### Community 108 - "Community 108"
Cohesion: 0.17
Nodes (15): add(), addCloseListener(), addTabAttachHandler(), cD(), eD(), Gy(), invalidateFrame(), oX() (+7 more)
...
Cohesion: 0.15
Nodes (13): Gn(), Jn(), JU(), Kn(), qL(), rU(), Ry(), tc() (+5 more)

### Community 120 - "Community 120"
Cohesion: 0.32
Nodes (13): _0(), GR(), hU(), ks(), Lo(), mu(), Ne(), Pn() (+5 more)
...
Cohesion: 0.21
Nodes (12): Ao(), captureEvent(), captureException(), I0(), jm(), JP(), lm(), _prepareEvent() (+4 more)

### Community 128 - "Community 128"
Cohesion: 0.24
Nodes (12): Bo(), captureMessage(), eventFromException(), eventFromMessage(), gO(), hO(), jee(), Kr() (+4 more)

### Community 129 - "Community 129"
Cohesion: 0.17
Nodes (12): addEventProcessor(), addIntegration(), e0(), getTransport(), init(), oO(), Re(), _setupIntegrations() (+4 more)

### Community 130 - "Community 130"
Cohesion: 0.26
Nodes (12): getIsolationScope(), getScopeData(), getSession(), gU(), Mz(), qM(), setSession(), toContext() (+4 more)
...
Cohesion: 0.27
Nodes (11): at(), e1(), enableOopifAutoAttach(), enableOopifAutoAttachForTarget(), executeTargetCdp(), GP(), initializeAttachedFrameSession(), runAttachedFrameSessionInitialization() (+3 more)

### Community 138 - "Community 138"
Cohesion: 0.2
Nodes (11): bte(), cn(), Et(), fte(), gte(), hte(), In(), vte() (+3 more)
...
Cohesion: 0.2
Nodes (10): admin_system_info(), Get system configuration and version info., get_system_info(), Get system information for the admin dashboard., Get system information for the admin dashboard., Get system information for the admin dashboard., Get system information for the admin dashboard., Get system information for the admin dashboard. (+2 more)
...
Cohesion: 0.22
Nodes (10): ch(), e6(), Il(), J3(), lx(), Q3(), sh(), trim() (+2 more)

### Community 146 - "Community 146"
Cohesion: 0.27
Nodes (10): Do(), gB(), IM(), jZ(), Rm(), Ss(), vB(), xs() (+2 more)
...
Cohesion: 0.2
Nodes (10): currentPointInParentFrame(), currentTopLevelPointForAction(), Dy(), evaluateOnPlaywrightSelectorAll(), evaluateOnPlaywrightSelectorWithTarget(), obstructingFrameHitTarget(), performPointerAction(), readElementState() (+2 more)
...
Cohesion: 0.25
Nodes (9): ec(), gH(), NW(), OW(), PU(), qte(), tn(), yte() (+1 more)

### Community 156 - "Community 156"
Cohesion: 0.25
Nodes (9): cleanup(), cleanupPageClipboards(), cleanupTab(), cleanupTarget(), ensure(), ensurePageClipboard(), hD(), install() (+1 more)
...
Cohesion: 0.29
Nodes (8): Hee(), k0(), n(), _unrollOther(), uQ(), vO(), wee(), Xo()

### Community 165 - "Community 165"
Cohesion: 0.25
Nodes (8): abort(), focusLocator(), $i(), Kee(), Kte(), nN(), remove(), RL()
...
Cohesion: 0.29
Nodes (7): getPropagationContext(), gM(), l0(), Lu(), Os(), sq(), xr()

### Community 174 - "Community 174"
Cohesion: 0.29
Nodes (7): handleIncomingMessage(), handleIncomingRequest(), sendMessage(), sendNotification(), Su(), superRefine(), Xx()

### Community 175 - "Community 175"
Cohesion: 0.33
Nodes (7): F3(), getHistoryPermission(), handleHistoryPromptResult(), IW(), pD(), Rx(), _x()

### Community 176 - "Community 176"
Cohesion: 0.29
Nodes (7): Bi(), complete(), _h(), qf(), _v(), xA(), Xf()
...
Cohesion: 0.4
Nodes (5): a1(), gv(), J_(), n7(), P7()

### Community 194 - "Community 194"
Cohesion: 0.5
Nodes (5): activeJsDialog(), iI(), Jq(), qg(), updateJsDialogPrompt()

### Community 195 - "Community 195"
Cohesion: 0.5
Nodes (5): g7(), H1(), Lp(), s7(), W1()

### Community 196 - "Community 196"
Cohesion: 0.5
Nodes (5): aj(), isCurrentInternalScreencastEvent(), isInternalScreencastEvent(), yp(), ZP()

### Community 197 - "Community 197"
Cohesion: 0.4
Nodes (5): clone(), eX(), mD(), rz(), update()
...
## Knowledge Gaps
- **699 isolated node(s):** `Application configuration loaded from environment variables.`, `Parse comma-separated CORS origins into a list.`, `Resolve knowledge_base_dir relative to backend/ root.`, `Extract the host portion from supabase_url (e.g. tesfafbkhbleipxbpcpk).`, `Async PostgreSQL connection string for SQLAlchemy (asyncpg).` (+694 more)
...
- **Why does `counter()` connect `Community 189` to `Community 0`, `Community 136`, `Community 181`, `Community 182`, `Community 190`?**
  _High betweenness centrality (0.067) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 136` to `Community 5`, `Community 189`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 182` to `Community 5`, `Community 189`?**
