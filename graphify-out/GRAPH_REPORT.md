...
## Corpus Check
- 224 files · ~4,050,830 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4953 nodes · 13607 edges · 332 communities (246 shown, 86 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 841 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `c46724cf`
...
## Communities (332 total, 86 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.01
Nodes (31): assertClientRequestTaskCapability(), assertTaskCapability(), assertTaskHandlerCapability(), assertToolsCallTaskCapability(), base64ToUint8Array(), base64urlToUint8Array(), _catch(), _catch2() (+23 more)

### Community 1 - "Community 1"
Cohesion: 0.02
Nodes (197): _$(), $4(), _5(), $8(), A4(), a5(), a7(), a8() (+189 more)
...
Cohesion: 0.05
Nodes (82): activeJsDialog(), bg(), bq(), browserAuthSelector(), CW(), deepPartial(), Dg(), Dn() (+74 more)
...
Cohesion: 0.05
Nodes (57): ExtractionSource, OrderStatus, Pydantic schemas for API request/response validation., RouterFailureType, Sentiment, TargetAgentState, TicketPriority, TicketStatus (+49 more)
...
Cohesion: 0.07
Nodes (67): a(), aA(), Aq(), bA(), Be(), browserName(), bt(), ca() (+59 more)
...
Cohesion: 0.09
Nodes (51): An(), callCdpTarget(), callRuntimeEvaluateInExecutionTarget(), callRuntimeEvaluateWithPlaywrightInjectedInTarget(), deletePlaywrightFrameWorld(), describeBackendNodeForHitTarget(), ds(), Dy() (+43 more)

### Community 13 - "Community 13"
Cohesion: 0.07
Nodes (49): Ag(), buildRevision(), _capture(), captureAX(), captureCandidate(), captureDocuments(), captureJavaScriptDialog(), clearPollingTimer() (+41 more)

### Community 14 - "Community 14"
Cohesion: 0.08
Nodes (47): _0(), Bn(), bte(), clone(), cn(), getClient(), getIsolationScope(), getScope() (+39 more)
...
Cohesion: 0.1
Nodes (45): _checkInitializationStatus(), _checkUserHasIdForEvaluation(), _createErrorUpdateDetails(), $emt(), _enqueueExposure(), finalize(), _finalizeUpdate(), getConfig() (+37 more)

### Community 19 - "Community 19"
Cohesion: 0.07
Nodes (45): aj(), allowBeforeUnload(), assertFullCdpEnabled(), attachedTabIdForCdpEvent(), Av(), callInputDispatch(), clickLocator(), deleteJsDialogForTarget() (+37 more)

### Community 20 - "Community 20"
Cohesion: 0.11
Nodes (41): product_node(), Node: Product Domain Agent., Node: Product Domain Agent., ProductDomainContext, Bounded context that ProductAgent receives for each turn., Bounded context that ProductAgent receives for each turn., Explicit, strongly typed multi-turn workflow orchestration state.     Serves as, Explicit, strongly typed multi-turn workflow orchestration state.     Serves as (+33 more)

### Community 21 - "Community 21"
Cohesion: 0.06
Nodes (41): cancel_order(), get_chat_history(), get_customer_history(), get_ticket(), process_refund(), Database Tools — Supabase operations that power both the MCP server and the Fast, Get past chat conversations for a customer., Get past chat conversations for a customer. (+33 more)
...
Cohesion: 0.07
Nodes (24): ProductSkillResolver, List all product-domain skills from the central registry., List all product-domain skills from the central registry., List all product-domain skills from the central registry., List all product-domain skills from the central registry., Deterministic skill resolution for the Product domain.     Python selects the sk, Deterministic skill resolution for the Product domain.      Delegates actual ski, Deterministic skill resolution for the Product domain.      Delegates actual ski (+16 more)

### Community 24 - "Community 24"
Cohesion: 0.08
Nodes (38): classify_intent(), get_router_llm(), parse_and_validate_router_output(), Intent Router Agent — classifies customer intent and sentiment, then routes to, Get the small LLM for fast routing decisions., Deterministic parsing boundary to handle markdown-wrapped JSON from the provider, Get the small LLM for fast routing decisions., Classify the intent, sentiment, and urgency of a customer message.      Args: (+30 more)

### Community 25 - "Community 25"
Cohesion: 0.07
Nodes (40): _addCheck(), append(), base64(), base64url(), cidr(), cuid(), cuid2(), date() (+32 more)
...
Cohesion: 0.1
Nodes (35): test_active_ticket_changed_order_creates(), test_active_ticket_compatible_intent_updates(), test_active_ticket_compatible_issue_no_identifiers_updates(), test_active_ticket_incompatible_intent_creates(), test_active_ticket_new_order_updates(), test_active_ticket_new_order_updates_and_returns_new_order(), test_active_ticket_unknown_product_new_product_updates(), test_ambiguous_candidates_safe_behavior() (+27 more)

### Community 28 - "Community 28"
Cohesion: 0.07
Nodes (39): $1(), _7(), addToNumericResult(), array(), aX(), C3(), Cs(), cx() (+31 more)

### Community 29 - "Community 29"
Cohesion: 0.07
Nodes (39): assertCompatibleLocator(), assertRequiredDocumentationRead(), Bi(), bundle(), complete(), cv(), dv(), evaluateOnPlaywrightSelector() (+31 more)

### Community 30 - "Community 30"
Cohesion: 0.06
Nodes (39): a(), bundle(), _c(), content(), dc(), dirty(), ea(), f() (+31 more)
...
Cohesion: 0.08
Nodes (38): adjustForFailure(), adjustForSuccess(), attachErrorIfNoneExists(), _attemptScheduledFlush(), batchSize(), _clearAllTimers(), _executeFlush(), finally() (+30 more)
...
Cohesion: 0.07
Nodes (34): addAttachment(), addEventProcessor(), addScopeListener(), e0(), fz(), Gn(), Gx(), jh() (+26 more)

### Community 38 - "Community 38"
Cohesion: 0.19
Nodes (20): RiskLevel, SkillExecutionStatus, SkillDefinition, SkillMetadata, SkillPolicy, SkillWorkflow, load_from_file(), SkillLoader (+12 more)

### Community 39 - "Community 39"
Cohesion: 0.08
Nodes (32): bD(), CJ(), cm(), createInventory(), cY(), dW(), fW(), getActive() (+24 more)
...
Cohesion: 0.07
Nodes (30): TicketCreate, TicketResponse, TicketUpdate, admin_reingest_kb(), admin_update_llm_settings(), cancel_order_endpoint(), customer_history(), dashboard_stats() (+22 more)

### Community 42 - "Community 42"
Cohesion: 0.1
Nodes (31): cachedBlocked(), deleteFileChoosersForTab(), deleteFrameSession(), deleteFrameSessionsForTab(), detachAttachedFrameTargets(), discardRawCdpEventsForTab(), documentation(), ensureRuntimeEnabled() (+23 more)
...
Cohesion: 0.1
Nodes (29): $(), assertCompatibleLocator(), Do(), eo(), evaluate(), evaluateAll(), exclude(), filter() (+21 more)
...
Cohesion: 0.16
Nodes (25): WarrantyStatusResult, check_warranty_status(), Deterministically check warranty status for a customer's purchase., Deterministically check warranty status for a customer's purchase., Deterministically check warranty status for a customer's purchase., Deterministically check warranty status for a customer's purchase., build_mock_order(), create_mock_supabase() (+17 more)
...
Cohesion: 0.08
Nodes (28): allowDownload(), attachTarget(), claimTab(), claimUserTab(), closeTab(), createTab(), detach(), detachTab() (+20 more)

### Community 54 - "Community 54"
Cohesion: 0.08
Nodes (28): addEvent(), addToPendingEventsQueue(), appendAndResetNonExposedChecks(), checkQuickFlush(), containsAtLeastOneFullBatch(), debug(), enqueue(), _enqueueDiagnosticsEvent() (+20 more)
...
Cohesion: 0.09
Nodes (20): LLMAdapter, ProductAgentResponse, Product Agent (Phase D.1)  Owns product-domain reasoning. Receives semantic cont, # NOTE: This single-primary-tool pattern is temporary for the D.1 vertical slice, Structured response produced by ProductAgent., Structured response produced by ProductAgent., Structured response produced by ProductAgent., Structured response produced by ProductAgent. (+12 more)

### Community 61 - "Community 61"
Cohesion: 0.12
Nodes (25): A6(), aI(), C6(), cre(), dirty(), _getInvalidInput(), _getOrReturnCtx(), _getType() (+17 more)

### Community 62 - "Community 62"
Cohesion: 0.08
Nodes (19): create_new_ticket(), Create a new support ticket., get_customer_by_id(), Look up a customer strictly by their ID., Look up a customer strictly by their ID., Look up a customer strictly by their ID., Test customer lookup and retrieval., Test customer lookup and retrieval. (+11 more)
...
Cohesion: 0.11
Nodes (24): addIntegration(), _fetchAndPrepFromNetwork(), fetchBlocked(), fetchEvaluations(), _fetchFromNetwork(), _getCacheKey(), getDataAsync(), _getDataAsyncImpl() (+16 more)

### Community 65 - "Community 65"
Cohesion: 0.13
Nodes (24): aK(), bU(), eK(), eW(), handleCdpEvent(), hte(), iK(), isDownload() (+16 more)
...
Cohesion: 0.12
Nodes (23): bL(), CL(), e6(), EL(), EM(), endsWith(), Fj(), gL() (+15 more)

### Community 68 - "Community 68"
Cohesion: 0.11
Nodes (23): abort(), callRawCdp(), currentTopLevelUrl(), deleteJsDialog(), En(), ensurePlaywrightInjected(), isFinite(), k7() (+15 more)

### Community 69 - "Community 69"
Cohesion: 0.11
Nodes (23): AP(), EP(), eV(), _extractBootstrapMetadata(), fn(), fr(), hO(), ip() (+15 more)

### Community 70 - "Community 70"
Cohesion: 0.09
Nodes (19): list_customers(), Get all customers with pagination., get_all_customers(), Get all customers with pagination., Get all customers with pagination., Get all customers with pagination., Get all customers with pagination., Get all customers with pagination. (+11 more)

### Community 71 - "Community 71"
Cohesion: 0.1
Nodes (22): beacon(), fetchLiveEvaluations(), getContext(), _getInternalRequestArgs(), getLiveCursor(), getLocalVariables(), _getPopulatedURL(), _getProperties() (+14 more)
...
Cohesion: 0.1
Nodes (11): GraphLLMAdapter, Register a validated skill. Prevents duplicates., Dynamically load all SKILL.md files from a directory tree., Resolve a skill by stable name., List all skills, optionally filtered by domain., Registry for loading and resolving domain skills.     Ensures that only valid, u, SkillRegistry, SKILL.md → SkillLoader → SkillRegistry → ProductSkillResolver → resolve (+3 more)

### Community 74 - "Community 74"
Cohesion: 0.1
Nodes (21): b3(), #e(), EJ(), hf(), identityForElement(), Jo(), jV(), O0() (+13 more)

### Community 75 - "Community 75"
Cohesion: 0.18
Nodes (21): callTarget(), captureSessions(), catch(), cleanup(), cleanupPageClipboards(), cleanupTab(), cleanupTarget(), enableAccessibility() (+13 more)

### Community 76 - "Community 76"
Cohesion: 0.11
Nodes (19): global_exception_handler(), health_check(), lifespan(), FastAPI Application Entry Point — main.py  Serves: - REST API on /api/v1/* -, Catch unhandled exceptions and return a clean JSON error + log it., Customer chat — auto-generates a session ID., Customer chat — resumes an existing session., Agent dashboard — monitor and take over a customer session. (+11 more)
...
Cohesion: 0.16
Nodes (19): Ah(), bH(), ch(), dH(), ec(), fH(), gH(), hH() (+11 more)
...
Cohesion: 0.11
Nodes (15): Conditional edge function to determine the next node., Conditional edge function to determine the next node., Conditional edge function to determine the next node., Conditional edge function to determine the next node., Conditional edge function to determine the next node., Conditional edge function to determine the next node., Conditional edge function to determine the next node., route_after_classification() (+7 more)
...
Cohesion: 0.18
Nodes (18): _clearOutcomes(), close(), emit(), flush(), _flushOutcomes(), gB(), h0(), _isClientDoneProcessing() (+10 more)

### Community 94 - "Community 94"
Cohesion: 0.14
Nodes (18): add(), addCloseListener(), addTabAttachHandler(), cD(), DI(), eD(), Gy(), Ig() (+10 more)

### Community 95 - "Community 95"
Cohesion: 0.17
Nodes (18): actionError(), check(), clear(), click(), dblclick(), double_click(), downloadMedia(), fill() (+10 more)
...
Cohesion: 0.14
Nodes (17): Az(), b(), c(), captureSession(), dU(), fB(), getEventProcessors(), jB() (+9 more)

### Community 99 - "Community 99"
Cohesion: 0.18
Nodes (17): attachDebuggerFrameTarget(), currentSession(), Dp(), getCurrentTurnId(), handleAttachedToTarget(), ie(), needsReclaim(), nextRawCdpEventSequence() (+9 more)
...
Cohesion: 0.18
Nodes (16): at(), attach(), Bk(), e1(), enableOopifAutoAttach(), enableOopifAutoAttachForTarget(), ensureAttachedTab(), executeTargetCdp() (+8 more)
...
Cohesion: 0.13
Nodes (13): _execute_tool(), Execute a database tool by name, injecting the authenticated customer_id securel, Execute a database tool by name, injecting the authenticated customer_id securel, Execute a database tool by name, injecting the authenticated customer_id securel, Execute a database tool by name, injecting the authenticated customer_id securel, Execute a database tool by name, injecting the authenticated customer_id securel, Execute a database tool by name, injecting the authenticated customer_id securel, Search for official warranty support information for a verified manufacturer. (+5 more)

### Community 107 - "Community 107"
Cohesion: 0.15
Nodes (15): aM(), emitNamedEntityData(), emitNotTerminatedNamedEntity(), end(), fail(), Fi(), Gj(), handleData() (+7 more)

### Community 108 - "Community 108"
Cohesion: 0.2
Nodes (15): clickDomCuaNode(), clickPoint(), dispatchCdpMouseMove(), dispatchCdpMouseRelease(), dispatchKeyPress(), dispatchMouseDown(), dispatchMouseMove(), dispatchMouseUp() (+7 more)

### Community 109 - "Community 109"
Cohesion: 0.15
Nodes (15): a1(), bv(), enableDownload(), gv(), hv(), Hz(), i1(), includes() (+7 more)

### Community 110 - "Community 110"
Cohesion: 0.21
Nodes (15): a0(), bB(), CO(), cte(), getDsn(), getOptions(), getSdkMetadata(), Hm() (+7 more)
...
Cohesion: 0.19
Nodes (14): aD(), all(), dispose(), eq(), handleHistoryPromptResult(), id(), JA(), Ok() (+6 more)

### Community 118 - "Community 118"
Cohesion: 0.19
Nodes (14): AB(), captureCheckIn(), ct(), Gz(), IB(), kB(), Mo(), p0() (+6 more)
...
Cohesion: 0.22
Nodes (13): call(), ck(), continueResponse(), ensureInterceptionReady(), ensurePageClipboard(), getBackendNodeViewportPoint(), handleEvent(), lk() (+5 more)

### Community 123 - "Community 123"
Cohesion: 0.17
Nodes (13): dm(), ij(), JW(), LW(), mM(), nM(), Q_(), readFile() (+5 more)

### Community 124 - "Community 124"
Cohesion: 0.18
Nodes (13): addEventListener(), addTabCleanupHandler(), constructor(), createNamespace(), _getLogEventCompressionMode(), _memoize(), _primeReadyRipcord(), registerRequestHandlerObject() (+5 more)

### Community 125 - "Community 125"
Cohesion: 0.23
Nodes (13): Ao(), captureEvent(), captureException(), I0(), jm(), JP(), lm(), _prepareEvent() (+5 more)
...
Cohesion: 0.18
Nodes (12): aW(), cI(), format(), J_(), o(), Ree(), removeAttribute(), _runExecutor() (+4 more)

### Community 130 - "Community 130"
Cohesion: 0.17
Nodes (12): BX(), dx(), fX(), isEmpty(), mX(), NW(), OW(), Px() (+4 more)

### Community 131 - "Community 131"
Cohesion: 0.21
Nodes (12): addListener(), cee(), g0(), Hn(), jte(), on(), qU(), setClient() (+4 more)

### Community 132 - "Community 132"
Cohesion: 0.18
Nodes (12): addBreadcrumb(), As(), cz(), dz(), Is(), Pz(), Qb(), recordDroppedEvent() (+4 more)

### Community 133 - "Community 133"
Cohesion: 0.23
Nodes (12): d0(), Do(), Et(), fq(), iO(), kz(), mq(), sZ() (+4 more)
...
Cohesion: 0.18
Nodes (11): AL(), configureAndConnect(), connect(), Il(), isIP(), No(), OU(), uB() (+3 more)

### Community 141 - "Community 141"
Cohesion: 0.27
Nodes (11): bM(), By(), c0(), kp(), Ns(), nZ(), oZ(), Pp() (+3 more)
...
Cohesion: 0.24
Nodes (10): Au(), fm(), IM(), Iu(), ps(), Rm(), Ss(), uZ() (+2 more)
...
Cohesion: 0.27
Nodes (7): enforce_sandbox_safety(), evaluate_example(), MockSupabaseClient, MockSupabaseExecute, Discover every mutating tool's DB-client resolution path and verify it is mocked, Discover every mutating tool's DB-client resolution path and verify it is mocked, run_baseline()
...
Cohesion: 0.28
Nodes (9): Aee(), Cr(), disableDownload(), _ee(), failPendingDownloadRequest(), failResponse(), handleDownloadResponse(), release() (+1 more)

### Community 152 - "Community 152"
Cohesion: 0.28
Nodes (9): clearPlaywrightFrameWorldsForTarget(), clearPlaywrightStateForTarget(), _configureUser(), dk(), E3(), ft(), keys(), updateUserWithAnalyticsOnlyMetadata() (+1 more)

### Community 153 - "Community 153"
Cohesion: 0.25
Nodes (9): d3(), ez(), Fee(), Iee(), k(), qy(), toLowerCase(), V3() (+1 more)
...
Cohesion: 0.25
Nodes (8): BW(), eb(), gO(), jee(), KW(), lee(), Nee(), qee()

### Community 160 - "Community 160"
Cohesion: 0.32
Nodes (8): getActiveFallbackUrl(), getChecksum(), Ld(), O9(), tryBumpExpiryTime(), _updateFallbackInfoWithNewUrl(), VI(), yb()

### Community 161 - "Community 161"
Cohesion: 0.25
Nodes (8): fO(), getPropagationContext(), gM(), Os(), removeEventListener(), us(), xr(), z$()
...
Cohesion: 0.29
Nodes (7): getConfigList(), _getConfigListImpl(), _getLiveDetails(), iy(), oy(), _retainDroppedLiveValues(), vp()

### Community 168 - "Community 168"
Cohesion: 0.29
Nodes (7): IZ(), m0(), Mk(), nQ(), Vt(), wu(), yr()

### Community 169 - "Community 169"
Cohesion: 0.43
Nodes (7): Bo(), captureMessage(), eventFromException(), eventFromMessage(), Kr(), LQ(), Ts()

### Community 170 - "Community 170"
Cohesion: 0.29
Nodes (7): focusLocator(), $i(), Kee(), Kte(), nN(), remove(), RL()
...
Cohesion: 0.4
Nodes (5): sendMessage(), sendNotification(), Su(), superRefine(), Xx()
...
## Knowledge Gaps
- **725 isolated node(s):** `Application configuration loaded from environment variables.`, `Parse comma-separated CORS origins into a list.`, `Resolve knowledge_base_dir relative to backend/ root.`, `Extract the host portion from supabase_url (e.g. tesfafbkhbleipxbpcpk).`, `Async PostgreSQL connection string for SQLAlchemy (asyncpg).` (+720 more)
...
- **Why does `main()` connect `Community 10` to `Community 7`?**
