...
## Corpus Check
- 226 files · ~4,055,990 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5013 nodes · 13747 edges · 340 communities (252 shown, 88 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 879 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e296db2c`
...
- `test_sentiment_urgency_override()` --calls--> `classify_intent()`  [INFERRED]
  backend/tests/test_router_parser.py → backend/app/agents/intent_router.py

## Communities (340 total, 88 thin omitted)
...
Cohesion: 0.02
Nodes (217): _$(), $4(), _5(), $8(), A4(), a5(), a7(), a8() (+209 more)
...
Cohesion: 0.02
Nodes (117): _array(), _base64(), base642(), _base64url(), base64url2(), _bigint(), bigint2(), _boolean() (+109 more)
...
Cohesion: 0.05
Nodes (61): _addCheck(), append(), base64(), base64url(), bq(), bte(), cidr(), CL() (+53 more)
...
Cohesion: 0.06
Nodes (54): addEventListener(), addListener(), addTabCleanupHandler(), AL(), c0(), cee(), constructor(), createNamespace() (+46 more)
...
Cohesion: 0.05
Nodes (53): assertCompatibleLocator(), assertRequiredDocumentationRead(), B5(), bundle(), cD(), cv(), Do(), dv() (+45 more)

### Community 12 - "Community 12"
Cohesion: 0.07
Nodes (39): OrchestrationDomain, SupervisorAction, ExtractionSource, OrderStatus, Pydantic schemas for API request/response validation., RouterFailureType, Sentiment, TargetAgentState (+31 more)

### Community 13 - "Community 13"
Cohesion: 0.09
Nodes (47): An(), callCdpTarget(), callRuntimeEvaluateInExecutionTarget(), callRuntimeEvaluateWithPlaywrightInjectedInTarget(), clearPlaywrightStateForTarget(), deletePlaywrightFrameWorld(), ds(), Dy() (+39 more)

### Community 14 - "Community 14"
Cohesion: 0.08
Nodes (48): _0(), Bn(), captureSession(), clone(), getClient(), getIsolationScope(), getScope(), getScopeData() (+40 more)

### Community 15 - "Community 15"
Cohesion: 0.07
Nodes (48): addEvent(), addToPendingEventsQueue(), adjustForFailure(), adjustForSuccess(), _attemptScheduledFlush(), batchSize(), _clearAllTimers(), containsAtLeastOneFullBatch() (+40 more)

### Community 16 - "Community 16"
Cohesion: 0.06
Nodes (45): cancel_order(), get_chat_history(), get_customer_by_id(), get_customer_history(), get_ticket(), process_refund(), Database Tools — Supabase operations that power both the MCP server and the Fast, Get past chat conversations for a customer. (+37 more)
...
Cohesion: 0.1
Nodes (44): actionError(), allTextContents(), and(), cachedRead(), check(), clear(), click(), count() (+36 more)
...
Cohesion: 0.09
Nodes (40): Ag(), _capture(), captureCandidate(), catch(), cleanup(), cleanupPageClipboards(), cleanupTab(), cleanupTarget() (+32 more)
...
Cohesion: 0.17
Nodes (28): ProductAgentResponse, Structured response produced by ProductAgent., Structured response produced by ProductAgent., Structured response produced by ProductAgent., Structured response produced by ProductAgent., RiskLevel, SkillExecutionStatus, SkillDefinition (+20 more)
...
Cohesion: 0.1
Nodes (19): ProductSkillResolver, Deterministic skill resolution for the Product domain.     Python selects the sk, Deterministic skill resolution for the Product domain.      Delegates actual ski, Deterministic skill resolution for the Product domain.      Delegates actual ski, Deterministic skill resolution for the Product domain.      Delegates actual ski, Deterministic skill resolution for the Product domain.      Delegates actual ski, make_product_info_skill(), make_registry_with_product_skill() (+11 more)
...
Cohesion: 0.12
Nodes (33): create_base_state(), test_ambiguous_semantic_domain(), test_apply_decision_clarification(), test_apply_decision_valid_invariant(), test_approval_not_silently_authorized(), test_completed_product_general_request(), test_completed_product_new_product_issue(), test_completed_product_order_message() (+25 more)
...
Cohesion: 0.07
Nodes (24): list_tickets(), Get all tickets with optional status filter., get_all_tickets(), Get all tickets with optional status filter., Get all tickets with optional status filter., Get all tickets with optional status filter., Get all tickets with optional status filter., Get all tickets with optional status filter. (+16 more)

### Community 39 - "Community 39"
Cohesion: 0.1
Nodes (30): A6(), aI(), C6(), dH(), dirty(), _getCached(), _getInvalidInput(), _getOrReturnCtx() (+22 more)

### Community 40 - "Community 40"
Cohesion: 0.13
Nodes (30): attachErrorIfNoneExists(), _checkInitializationStatus(), _checkUserHasIdForEvaluation(), $emt(), _enqueueDiagnosticsEvent(), _enqueueExposure(), _extractBootstrapMetadata(), finalize() (+22 more)

### Community 41 - "Community 41"
Cohesion: 0.07
Nodes (30): aborted(), assertCanSetRequestHandler(), assertNotificationCapability(), _enqueueTaskMessage(), explicitlyAborted(), handleArrayResult(), handleCanaryResult(), handleCatchall() (+22 more)
...
Cohesion: 0.12
Nodes (26): classify_semantic_intent(), get_semantic_router_llm(), parse_and_validate_semantic_output(), Semantic Router Agent (Phase B) Classifies the semantic domain, intent, sentime, Classify the message and output a strongly typed SemanticRouteResult.     Catch, Parses LLM output, enforcing the SemanticRouteResult schema and capturing failur, RouterDiagnostics, SemanticRouteResult (+18 more)

### Community 45 - "Community 45"
Cohesion: 0.09
Nodes (29): aX(), C3(), clearPlaywrightFrameWorldsForTarget(), cm(), _configureUser(), cx(), _D(), dD() (+21 more)

### Community 46 - "Community 46"
Cohesion: 0.1
Nodes (29): AB(), Au(), Bo(), captureCheckIn(), captureMessage(), ct(), eventFromException(), eventFromMessage() (+21 more)
...
Cohesion: 0.17
Nodes (24): WarrantyStatusResult, check_warranty_status(), Deterministically check warranty status for a customer's purchase., Deterministically check warranty status for a customer's purchase., Deterministically check warranty status for a customer's purchase., Deterministically check warranty status for a customer's purchase., build_mock_order(), create_mock_supabase() (+16 more)
...
Cohesion: 0.1
Nodes (27): error(), _fetchAndPrepFromNetwork(), fetchBlocked(), _fetchFromNetwork(), frameIdentityForResolvedSelectorTarget(), _getCacheKey(), _getDataAsyncImpl(), _getIsCacheValueValid() (+19 more)

### Community 53 - "Community 53"
Cohesion: 0.08
Nodes (26): aM(), CU(), d5(), gd(), getByLabel(), getByText(), Gj(), handleBindingCall() (+18 more)

### Community 54 - "Community 54"
Cohesion: 0.1
Nodes (26): addAttachment(), addEventProcessor(), addScopeListener(), bH(), BX(), dx(), e0(), fz() (+18 more)

### Community 55 - "Community 55"
Cohesion: 0.13
Nodes (26): $1(), _7(), Cs(), ere(), Ey(), fU(), getConfig(), _getDetailedStoreResult() (+18 more)

### Community 56 - "Community 56"
Cohesion: 0.16
Nodes (26): a0(), _clearOutcomes(), close(), CO(), cte(), emit(), flush(), _flushOutcomes() (+18 more)
...
Cohesion: 0.09
Nodes (16): Application configuration loaded from environment variables., Settings, validate_log_level(), validate_supabase_key(), validate_supabase_url(), BaseSettings, validate_all_disjoint(), validate_disjoint() (+8 more)

### Community 61 - "Community 61"
Cohesion: 0.13
Nodes (25): aK(), bU(), buildRevision(), captureAX(), captureDocuments(), captureJavaScriptDialog(), eK(), eW() (+17 more)

### Community 62 - "Community 62"
Cohesion: 0.08
Nodes (18): Integration tests for Supabase database tools.  Tests customer lookup, order t, Test product/inventory operations., List all products in catalog., Search for a product by name., Search for non-existent product returns error., Test dashboard/analytics operations., Get dashboard statistics., Test product/inventory operations. (+10 more)
...
Cohesion: 0.08
Nodes (24): aj(), assertFullCdpEnabled(), b3(), CJ(), EJ(), fullCdpAccessState(), getInfo(), isFullCdpEnabled() (+16 more)

### Community 65 - "Community 65"
Cohesion: 0.12
Nodes (24): bL(), ch(), e6(), EM(), endsWith(), gL(), k0(), lx() (+16 more)

### Community 66 - "Community 66"
Cohesion: 0.14
Nodes (24): at(), attach(), attachDebuggerFrameTarget(), closeTab(), Dp(), e1(), enableFocusEmulation(), enableOopifAutoAttach() (+16 more)

### Community 67 - "Community 67"
Cohesion: 0.13
Nodes (24): beacon(), EP(), fetchEvaluations(), getActiveFallbackUrl(), _getInternalRequestArgs(), _getPopulatedURL(), _getRequestData(), getUrl() (+16 more)
...
Cohesion: 0.13
Nodes (23): activeJsDialog(), all(), BW(), CW(), dm(), fW(), getBrowsers(), getDefault() (+15 more)
...
Cohesion: 0.25
Nodes (22): aA(), Be(), bt(), ca(), dE(), dj(), Eg(), ensureCurrentTabFileTransferAllowed() (+14 more)
...
Cohesion: 0.12
Nodes (21): abort(), currentTopLevelUrl(), deleteJsDialog(), En(), ensurePlaywrightInjected(), isFinite(), J_(), k7() (+13 more)

### Community 77 - "Community 77"
Cohesion: 0.11
Nodes (21): addBreadcrumb(), As(), Az(), b(), bZ(), cz(), dB(), dz() (+13 more)
...
Cohesion: 0.11
Nodes (20): A9(), E9(), G9(), getChecksum(), instance(), J9(), ji(), K9() (+12 more)

### Community 83 - "Community 83"
Cohesion: 0.1
Nodes (20): attachTarget(), claimTab(), claimUserTab(), createTab(), detach(), detachTab(), detachTarget(), executeUnhandledCommand() (+12 more)

### Community 84 - "Community 84"
Cohesion: 0.18
Nodes (20): call(), callInputDispatch(), callTarget(), clickPoint(), dispatchCdpMouseMove(), dispatchCdpMouseRelease(), dispatchMouseDown(), dispatchMouseMove() (+12 more)
...
Cohesion: 0.11
Nodes (19): admin_get_kb_doc(), admin_list_kb(), List all knowledge base documents., Read a specific knowledge base document., get_knowledge_base_doc(), list_knowledge_base_docs(), List all knowledge base documents., List all knowledge base documents. (+11 more)
...
Cohesion: 0.13
Nodes (19): _createErrorUpdateDetails(), fetchLiveEvaluations(), getContext(), getLiveCursor(), getValues(), initializeAsync(), _initializeAsyncImpl(), initializeSync() (+11 more)

### Community 92 - "Community 92"
Cohesion: 0.14
Nodes (19): clearPollingTimer(), closeWatcher(), discoverRolloutPath(), dispose(), Fj(), hasActiveRollout(), isPathTracked(), lj() (+11 more)

### Community 93 - "Community 93"
Cohesion: 0.11
Nodes (19): a1(), aW(), cI(), evaluateOnPlaywrightSelector(), hW(), iy(), kg(), max() (+11 more)

### Community 94 - "Community 94"
Cohesion: 0.13
Nodes (19): activeRetiredInternalScreencastSessions(), add(), addCloseListener(), addTabAttachHandler(), captureSessions(), enableAccessibility(), Gy(), invalidateFrame() (+11 more)

### Community 95 - "Community 95"
Cohesion: 0.16
Nodes (19): bB(), clickDomCuaNode(), d0(), Eo(), fB(), getSdkMetadata(), Gz(), iO() (+11 more)
...
Cohesion: 0.18
Nodes (18): aD(), Bk(), dk(), eq(), fk(), hK(), id(), nQ() (+10 more)

### Community 101 - "Community 101"
Cohesion: 0.23
Nodes (18): evaluateJavascript(), Fg(), G$(), Gg(), hg(), isValueSettableForElement(), jy(), Ly() (+10 more)

### Community 102 - "Community 102"
Cohesion: 0.14
Nodes (18): ck(), clickLocator(), cY(), dW(), getBackendNodeViewportPoint(), hr(), hte(), Kn() (+10 more)

### Community 103 - "Community 103"
Cohesion: 0.15
Nodes (18): currentSession(), ensureInterceptionReady(), getCurrentTurnId(), handleAttachedToTarget(), ie(), iI(), Jq(), kp() (+10 more)
...
Cohesion: 0.12
Nodes (9): GraphLLMAdapter, Resolve a skill by stable name., List all skills, optionally filtered by domain., Registry for loading and resolving domain skills.     Ensures that only valid, u, SkillRegistry, SKILL.md → SkillLoader → SkillRegistry → ProductSkillResolver → resolve, SKILL.md → SkillLoader → SkillRegistry → ProductSkillResolver → resolve, SKILL.md → SkillLoader → SkillRegistry → ProductSkillResolver → resolve (+1 more)

### Community 106 - "Community 106"
Cohesion: 0.17
Nodes (16): apply_decision(), decide(), InvalidSupervisorDecisionError, _is_valid_domain(), Bounded typed representation of transition context.     F.1 LIMITATION: SUSPEND_, Bounded typed representation of transition context., Bounded typed representation of transition context., Deterministic Python Workflow Orchestrator.     Evaluates semantic facts against (+8 more)
...
Cohesion: 0.13
Nodes (17): allowBeforeUnload(), attachedTabIdForCdpEvent(), deleteJsDialogForTarget(), #e(), handleJavaScriptDialogEvent(), hf(), identityForElement(), Iv() (+9 more)

### Community 109 - "Community 109"
Cohesion: 0.18
Nodes (17): AP(), bM(), By(), ec(), fn(), gH(), hy(), mj() (+9 more)
...
Cohesion: 0.13
Nodes (14): _execute_tool(), Execute a database tool by name, injecting the authenticated customer_id securel, Execute a database tool by name, injecting the authenticated customer_id securel, Execute a database tool by name, injecting the authenticated customer_id securel, Execute a database tool by name, injecting the authenticated customer_id securel, Execute a database tool by name, injecting the authenticated customer_id securel, Execute a database tool by name, injecting the authenticated customer_id securel, Search for official warranty support information for a verified manufacturer. (+6 more)

### Community 112 - "Community 112"
Cohesion: 0.24
Nodes (14): calc_dpi_via_ooxml(), calc_dpi_via_pdf(), convert_to_pdf(), main(), rasterize(), Rasterise PPTX/PDF to PNG files placed in out_dir and return the image paths., Calculate DPI from OOXML `ppt/presentation.xml` slide size (cx/cy in EMUs)., Compute DPI from PDF page size.      For OOXML presentation inputs, use the pr (+6 more)
...
Cohesion: 0.13
Nodes (16): d3(), describeBackendNodeForHitTarget(), ez(), fX(), In(), k(), Kee(), Kte() (+8 more)

### Community 115 - "Community 115"
Cohesion: 0.15
Nodes (16): bv(), enableDownload(), FL(), gv(), hv(), Hz(), i1(), includes() (+8 more)

### Community 116 - "Community 116"
Cohesion: 0.2
Nodes (16): bg(), browserAuthSelector(), Dg(), Hn(), lI(), mg(), min(), Ng() (+8 more)

### Community 117 - "Community 117"
Cohesion: 0.14
Nodes (16): bD(), createInventory(), ensure(), ensurePageClipboard(), Fi(), getActive(), getTabs(), gw() (+8 more)
...
Cohesion: 0.15
Nodes (15): appendAndResetNonExposedChecks(), checkQuickFlush(), enqueue(), _getCurrentPageUrl(), _getEventsFromStorage(), _getStorageKey(), _initFlushCoordinator(), _loadStoredEvents() (+7 more)
...
Cohesion: 0.2
Nodes (15): Av(), dispatchKeyPress(), down(), Jf(), Jt(), keyText(), Ll(), Ml() (+7 more)

### Community 124 - "Community 124"
Cohesion: 0.16
Nodes (15): a(), Ah(), fH(), Gn(), hH(), Jn(), JU(), pH() (+7 more)

### Community 125 - "Community 125"
Cohesion: 0.17
Nodes (15): Aee(), continueResponse(), Cr(), _ee(), Fee(), handleEvent(), Hee(), Iee() (+7 more)
...
Cohesion: 0.23
Nodes (13): apply_table_geometry(), audit_docx_tables(), _ensure_child(), length_to_dxa(), main(), Apply exact, full-table Word geometry to a python-docx table.      Call this a, Print table width/indent/grid/cell-width checks. Returns issue count., Return a python-docx Length in DXA/twips. (+5 more)
...
Cohesion: 0.16
Nodes (14): cre(), Dl(), eD(), fv(), kd(), kt(), lre(), mt() (+6 more)

### Community 133 - "Community 133"
Cohesion: 0.14
Nodes (14): c(), callRawCdp(), configureAndConnect(), connect(), ff(), isIP(), l(), m() (+6 more)

### Community 134 - "Community 134"
Cohesion: 0.22
Nodes (8): _check_warranty_status_impl(), _parse_warranty_duration(), Deterministically parse warranty duration from product description., Deterministically parse warranty duration from product description., Deterministically parse warranty duration from product description., Internal implementation of warranty check with DB retries., Internal implementation of warranty check with DB retries., TestWarrantyParser

### Community 135 - "Community 135"
Cohesion: 0.24
Nodes (13): browserName(), ensureCommandAllowed(), ensureCurrentTabOriginAllowed(), ensureFileUploadAllowed(), ensureFullCdpAllowed(), ensurePageAssetDownloadAllowed(), ensureRawCdpUrlAllowed(), ensureRawCdpUrlAllowedForOperation() (+5 more)
...
Cohesion: 0.22
Nodes (11): bA(), DI(), ei(), fA(), G3(), HL(), Ig(), k3() (+3 more)

### Community 146 - "Community 146"
Cohesion: 0.24
Nodes (11): deleteFrameSession(), eV(), fr(), handleDetachedFromTarget(), handleFrameDetached(), handleFrameNavigated(), handleTargetEvent(), QP() (+3 more)
...
Cohesion: 0.38
Nodes (9): ensure_raster_image(), main(), _pillow_convert(), _rasterize_pdf_first_page(), _rasterize_svg(), _rasterize_svgz(), Return a raster image path for the given input, converting when needed.      -, _run_node_helper() (+1 more)
...
Cohesion: 0.38
Nodes (10): getFileTransferPermission(), getFullCdpPermission(), getOriginPermission(), gs(), handleFileTransferPromptResult(), handleFullCdpPromptResult(), handleOriginPromptResult(), hs() (+2 more)

### Community 154 - "Community 154"
Cohesion: 0.27
Nodes (10): Aq(), CG(), da(), ensurePageAssetFallbackFetchAllowed(), iq(), Lg(), oi(), s() (+2 more)
...
Cohesion: 0.31
Nodes (8): create_montage(), _load_images_with_placeholders(), main(), _make_placeholder(), _natural_key(), Create a visible placeholder tile with a light gray fill and a red X cross., Key function for natural sorting (e.g., Slide2 before Slide10)., Build a montage with a fixed number of columns.      Each cell has size `cell_
...
Cohesion: 0.25
Nodes (9): F3(), getHistoryPermission(), handleHistoryPromptResult(), IW(), nX(), pD(), Qk(), Rx() (+1 more)
...
Cohesion: 0.33
Nodes (7): Ao(), captureEvent(), captureException(), I0(), jm(), preprocessEvent(), _process()
...
Cohesion: 0.4
Nodes (4): List all product-domain skills from the central registry., List all product-domain skills from the central registry., List all product-domain skills from the central registry., List all product-domain skills from the central registry.
...
Cohesion: 0.67
Nodes (3): Test that RAG-grounded responses work correctly., Test that RAG-grounded responses work correctly., TestRAGResponses
...
## Knowledge Gaps
- **736 isolated node(s):** `Application configuration loaded from environment variables.`, `Parse comma-separated CORS origins into a list.`, `Resolve knowledge_base_dir relative to backend/ root.`, `Extract the host portion from supabase_url (e.g. tesfafbkhbleipxbpcpk).`, `Async PostgreSQL connection string for SQLAlchemy (asyncpg).` (+731 more)
...
- **Why does `counter()` connect `Community 188` to `Community 0`, `Community 178`, `Community 179`, `Community 180`, `Community 187`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 178` to `Community 188`, `Community 12`, `Community 159`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 180` to `Community 188`, `Community 12`?**
