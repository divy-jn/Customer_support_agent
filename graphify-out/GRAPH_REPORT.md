...
## Corpus Check
- 226 files · ~4,054,073 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4978 nodes · 13655 edges · 342 communities (255 shown, 87 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 848 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `971d57c3`
...
## Communities (342 total, 87 thin omitted)
...
Cohesion: 0.02
Nodes (211): _$(), $4(), _5(), $8(), A4(), a5(), a7(), a8() (+203 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (177): abort(), assert(), Au(), bd(), Bl(), bp(), Bu(), catchall() (+169 more)
...
Cohesion: 0.04
Nodes (70): decide(), Deterministic Python Workflow Orchestrator.     Evaluates semantic facts against, Supervisor, SupervisorAction, SupervisorDecision, ChatRequest, EscalationAlert, ExtractionSource (+62 more)

### Community 5 - "Community 5"
Cohesion: 0.05
Nodes (86): accept(), actionError(), all(), allTextContents(), and(), args(), array(), back() (+78 more)
...
Cohesion: 0.06
Nodes (64): _0(), Bn(), bq(), bte(), captureSession(), cn(), Dn(), ef() (+56 more)

### Community 9 - "Community 9"
Cohesion: 0.07
Nodes (57): An(), callCdpTarget(), callRuntimeEvaluateInExecutionTarget(), callRuntimeEvaluateWithPlaywrightInjectedInTarget(), currentPointInParentFrame(), currentTopLevelPointForAction(), deletePlaywrightFrameWorld(), describeBackendNodeForHitTarget() (+49 more)
...
Cohesion: 0.08
Nodes (44): test_active_ticket_changed_order_creates(), test_active_ticket_compatible_intent_updates(), test_active_ticket_compatible_issue_no_identifiers_updates(), test_active_ticket_incompatible_intent_creates(), test_active_ticket_new_order_updates(), test_active_ticket_new_order_updates_and_returns_new_order(), test_active_ticket_unknown_product_new_product_updates(), test_ambiguous_candidates_safe_behavior() (+36 more)

### Community 12 - "Community 12"
Cohesion: 0.05
Nodes (47): cancel_order(), get_chat_history(), get_customer_history(), get_ticket(), process_refund(), Database Tools — Supabase operations that power both the MCP server and the Fast, Get past chat conversations for a customer., Get past chat conversations for a customer. (+39 more)
...
Cohesion: 0.06
Nodes (44): A6(), _addCheck(), append(), base64(), base64url(), cidr(), configureAndConnect(), connect() (+36 more)

### Community 18 - "Community 18"
Cohesion: 0.07
Nodes (43): add(), assertCanSetRequestHandler(), catchall(), _check(), clone(), cloneDef(), convertBaseSchema(), convertSchema() (+35 more)
...
Cohesion: 0.08
Nodes (37): classify_intent(), parse_and_validate_router_output(), Intent Router Agent — classifies customer intent and sentiment, then routes to, Deterministic parsing boundary to handle markdown-wrapped JSON from the provider, Classify the intent, sentiment, and urgency of a customer message.      Args:, Classify the intent, sentiment, and urgency of a customer message.      Args:, Classify the intent, sentiment, and urgency of a customer message.      Args:, Intent Routing Evaluation Tests — validates the intent classification accuracy, (+29 more)
...
Cohesion: 0.1
Nodes (39): attachErrorIfNoneExists(), _configureUser(), _createErrorUpdateDetails(), _enqueueDiagnosticsEvent(), _extractBootstrapMetadata(), finalize(), _finalizeUpdate(), getCurrentSourceDetails() (+31 more)
...
Cohesion: 0.09
Nodes (38): adjustForFailure(), adjustForSuccess(), _attemptScheduledFlush(), batchSize(), _clearAllTimers(), containsAtLeastOneFullBatch(), _executeFlush(), finally() (+30 more)

### Community 27 - "Community 27"
Cohesion: 0.17
Nodes (29): ProductAgentResponse, Structured response produced by ProductAgent., Structured response produced by ProductAgent., Structured response produced by ProductAgent., Structured response produced by ProductAgent., RiskLevel, SkillExecutionStatus, SkillDefinition (+21 more)

### Community 28 - "Community 28"
Cohesion: 0.06
Nodes (33): admin_reingest_kb(), admin_update_llm_settings(), cancel_order_endpoint(), create_new_ticket(), customer_history(), dashboard_stats(), dev_login(), get_ticket_detail() (+25 more)
...
Cohesion: 0.09
Nodes (16): ProductSkillResolver, Deterministic skill resolution for the Product domain.     Python selects the sk, Deterministic skill resolution for the Product domain.      Delegates actual ski, Deterministic skill resolution for the Product domain.      Delegates actual ski, Deterministic skill resolution for the Product domain.      Delegates actual ski, Deterministic skill resolution for the Product domain.      Delegates actual ski, make_registry_with_product_skill(), 'product_warranty' contains 'product' as a substring but must NOT         silent (+8 more)

### Community 35 - "Community 35"
Cohesion: 0.08
Nodes (33): beacon(), EP(), error(), getActiveFallbackUrl(), getChecksum(), _getInternalRequestArgs(), _getPopulatedURL(), _getRequestData() (+25 more)

### Community 36 - "Community 36"
Cohesion: 0.09
Nodes (33): $1(), _7(), Au(), buildRevision(), captureJavaScriptDialog(), Cs(), ere(), Ey() (+25 more)

### Community 37 - "Community 37"
Cohesion: 0.09
Nodes (32): AP(), deleteFrameSession(), detachAttachedFrameTargets(), documentation(), ensureRuntimeEnabled(), g7(), get(), getPath() (+24 more)

### Community 38 - "Community 38"
Cohesion: 0.06
Nodes (29): check_inventory(), lookup_customer(), Check if a specific product is in stock and get its details., Check if a specific product is in stock and get its details., Check if a specific product is in stock and get its details., Check if a specific product is in stock and get its details., Check if a specific product is in stock and get its details., Check if a specific product is in stock and get its details. (+21 more)
...
Cohesion: 0.12
Nodes (29): aD(), call(), ck(), clickLocator(), clickPoint(), dispatchMouseDown(), dispatchMouseMove(), dispatchMouseUp() (+21 more)
...
Cohesion: 0.15
Nodes (27): activeJsDialog(), _capture(), captureCandidate(), commitCapture(), currentState(), DQ(), ensureTracked(), frameForId() (+19 more)

### Community 49 - "Community 49"
Cohesion: 0.12
Nodes (23): DBPlannerOutput, determine_db_action(), _extract_number(), generate_response(), get_db_llm(), Database / Memory Agent — handles customer-specific operations by querying the, Generate a response using database tool results.      Args:         message: The, Generate a response using database tool results.      Args:         message: (+15 more)
...
Cohesion: 0.12
Nodes (25): aI(), C6(), dirty(), fetchTools(), _getInvalidInput(), _getOrReturnCtx(), _getType(), implement() (+17 more)

### Community 53 - "Community 53"
Cohesion: 0.13
Nodes (25): aK(), bL(), bU(), eK(), EM(), eW(), gL(), handleCdpEvent() (+17 more)

### Community 54 - "Community 54"
Cohesion: 0.09
Nodes (25): eV(), fetchBlocked(), fetchLiveEvaluations(), fr(), getConfigList(), _getConfigListImpl(), getContext(), getLiveCursor() (+17 more)

### Community 55 - "Community 55"
Cohesion: 0.1
Nodes (25): add(), addCloseListener(), addEventListener(), addTabAttachHandler(), addTabCleanupHandler(), constructor(), createNamespace(), eb() (+17 more)

### Community 56 - "Community 56"
Cohesion: 0.1
Nodes (25): addAttachment(), addScopeListener(), bH(), ch(), enableDownload(), Gx(), isEmpty(), jh() (+17 more)
...
Cohesion: 0.11
Nodes (24): Ag(), clearPollingTimer(), closeWatcher(), discoverRolloutPath(), dispose(), Fj(), getAssets(), _getFirstCachedFrame() (+16 more)

### Community 59 - "Community 59"
Cohesion: 0.11
Nodes (24): callRawCdp(), closeTab(), currentTopLevelUrl(), deleteFileChoosersForTab(), deleteFrameSessionsForTab(), detach(), detachTab(), discardRawCdpEventsForTab() (+16 more)

### Community 60 - "Community 60"
Cohesion: 0.13
Nodes (24): bg(), browserAuthSelector(), Dg(), e6(), endsWith(), Hn(), J3(), lI() (+16 more)

### Community 61 - "Community 61"
Cohesion: 0.11
Nodes (22): get_test_customer_id(), make_state(), Tests for the LangGraph agent flow — verifies intent routing and end-to-end gra, Test end-to-end LangGraph execution., Test end-to-end LangGraph execution., Test that RAG-grounded responses work correctly., Test that RAG-grounded responses work correctly., Get the first customer ID from the database for testing. (+14 more)
...
Cohesion: 0.13
Nodes (23): assertCompatibleLocator(), assertRequiredDocumentationRead(), cD(), Fd(), filter(), gI(), kg(), NW() (+15 more)

### Community 65 - "Community 65"
Cohesion: 0.12
Nodes (23): abort(), callTarget(), catch(), cleanup(), cleanupPageClipboards(), cleanupTab(), cleanupTarget(), deleteJsDialog() (+15 more)

### Community 66 - "Community 66"
Cohesion: 0.1
Nodes (23): Aee(), continueResponse(), Cr(), disableDownload(), _ee(), EJ(), failPendingDownloadRequest(), failResponse() (+15 more)

### Community 67 - "Community 67"
Cohesion: 0.09
Nodes (23): attachTarget(), claimTab(), claimUserTab(), createTab(), currentSession(), detachTarget(), executeUnhandledCommand(), getCurrentSessionId() (+15 more)

### Community 68 - "Community 68"
Cohesion: 0.16
Nodes (22): a0(), Ao(), bB(), captureCheckIn(), captureEvent(), CO(), cte(), getDsn() (+14 more)

### Community 69 - "Community 69"
Cohesion: 0.13
Nodes (22): BX(), dx(), includes(), LW(), m0(), mX(), n(), nM() (+14 more)

### Community 70 - "Community 70"
Cohesion: 0.15
Nodes (22): at(), attach(), attachDebuggerFrameTarget(), e1(), enableFocusEmulation(), enableOopifAutoAttach(), enableOopifAutoAttachForTarget(), ensureAttachedTab() (+14 more)
...
Cohesion: 0.1
Nodes (21): _execute_tool(), Execute a database tool by name, injecting the authenticated customer_id securel, Execute a database tool by name, injecting the authenticated customer_id securel, Execute a database tool by name, injecting the authenticated customer_id securel, Execute a database tool by name, injecting the authenticated customer_id securel, Execute a database tool by name, injecting the authenticated customer_id securel, Execute a database tool by name, injecting the authenticated customer_id securel, get_dashboard_stats() (+13 more)

### Community 74 - "Community 74"
Cohesion: 0.1
Nodes (16): GraphLLMAdapter, Conditional edge function to determine the next node., Conditional edge function to determine the next node., Conditional edge function to determine the next node., Conditional edge function to determine the next node., Conditional edge function to determine the next node., Conditional edge function to determine the next node., Conditional edge function to determine the next node. (+8 more)

### Community 75 - "Community 75"
Cohesion: 0.14
Nodes (21): _clearOutcomes(), close(), dU(), emit(), flush(), _flushOutcomes(), gB(), h0() (+13 more)

### Community 76 - "Community 76"
Cohesion: 0.15
Nodes (21): cm(), cY(), dm(), dW(), evaluateOnPlaywrightSelector(), fW(), getBrowsers(), getDefault() (+13 more)

### Community 77 - "Community 77"
Cohesion: 0.26
Nodes (21): Be(), bt(), ca(), CG(), dE(), dj(), Eg(), ensureCommandAllowed() (+13 more)

### Community 78 - "Community 78"
Cohesion: 0.12
Nodes (17): generate_escalation_response(), get_escalation_llm(), Escalation Agent — handles angry customers or explicit human handoff requests., Get the small LLM for fast escalation processing., Generate an empathetic handover message., Generate an empathetic handover message., llm(), get_router_llm() (+9 more)
...
Cohesion: 0.12
Nodes (20): addEvent(), addToPendingEventsQueue(), appendAndResetNonExposedChecks(), checkQuickFlush(), debug(), enqueue(), _getCurrentPageUrl(), _getEventsFromStorage() (+12 more)

### Community 83 - "Community 83"
Cohesion: 0.1
Nodes (20): assertFullCdpEnabled(), cre(), fn(), fullCdpAccessState(), fv(), gw(), isFullCdpEnabled(), lm() (+12 more)

### Community 84 - "Community 84"
Cohesion: 0.13
Nodes (20): addListener(), AL(), cee(), fO(), g0(), jte(), No(), on() (+12 more)
...
Cohesion: 0.12
Nodes (19): addBreadcrumb(), As(), Az(), b(), bZ(), cz(), dB(), dz() (+11 more)
...
Cohesion: 0.16
Nodes (18): actionError(), check(), clear(), click(), dblclick(), downloadMedia(), evaluateAll(), fill() (+10 more)

### Community 98 - "Community 98"
Cohesion: 0.2
Nodes (18): Bk(), captureAX(), captureDocuments(), dk(), fk(), hK(), _isRateLimited(), jk() (+10 more)

### Community 99 - "Community 99"
Cohesion: 0.14
Nodes (18): a1(), all(), bv(), BW(), dv(), eq(), Gf(), gv() (+10 more)

### Community 100 - "Community 100"
Cohesion: 0.12
Nodes (18): A9(), E9(), G9(), instance(), J9(), ji(), K9(), logError() (+10 more)

### Community 101 - "Community 101"
Cohesion: 0.17
Nodes (18): browserName(), da(), ensureCurrentTabFileTransferAllowed(), ensureCurrentTabOriginAllowed(), ensureDownloadAllowed(), ensureFileUploadAllowed(), ensureFullCdpAllowed(), ensurePageAssetDownloadAllowed() (+10 more)

### Community 102 - "Community 102"
Cohesion: 0.14
Nodes (18): c(), d3(), ec(), ez(), format(), gH(), k(), m() (+10 more)
...
Cohesion: 0.12
Nodes (17): B5(), d5(), first(), gd(), getByLabel(), getByPlaceholder(), getByRole(), getByTestId() (+9 more)

### Community 106 - "Community 106"
Cohesion: 0.24
Nodes (15): create_base_state(), test_ambiguous_semantic_domain(), test_completed_product_new_product_issue(), test_completed_product_order_message(), test_deterministic_repeatability(), test_escalated_workflow(), test_mutation_boundaries(), test_no_active_workflow_product() (+7 more)

### Community 107 - "Community 107"
Cohesion: 0.19
Nodes (16): AB(), Bo(), captureException(), captureMessage(), ct(), eventFromException(), eventFromMessage(), IB() (+8 more)

### Community 108 - "Community 108"
Cohesion: 0.17
Nodes (16): addIntegration(), _fetchAndPrepFromNetwork(), fetchEvaluations(), _fetchFromNetwork(), _getCacheKey(), _getDataAsyncImpl(), _getIsCacheValueValid(), _getSdkKey() (+8 more)
...
Cohesion: 0.15
Nodes (15): fm(), gO(), hO(), IM(), Iu(), jee(), lz(), ps() (+7 more)

### Community 113 - "Community 113"
Cohesion: 0.18
Nodes (15): cachedBlocked(), CL(), DI(), EL(), ie(), Ig(), isBlocked(), nextRawCdpEventSequence() (+7 more)
...
Cohesion: 0.15
Nodes (14): and(), args(), bundle(), create(), createConnection(), exclude(), extract(), pipe() (+6 more)

### Community 120 - "Community 120"
Cohesion: 0.18
Nodes (14): allTextContents(), cachedRead(), count(), evaluate(), getAttribute(), innerText(), isEnabled(), isVisible() (+6 more)

### Community 121 - "Community 121"
Cohesion: 0.14
Nodes (14): dH(), focusLocator(), hW(), $i(), Kee(), Kte(), nN(), read() (+6 more)

### Community 122 - "Community 122"
Cohesion: 0.2
Nodes (14): aX(), C3(), clearPlaywrightFrameWorldsForTarget(), clearPlaywrightStateForTarget(), cx(), _D(), E3(), ft() (+6 more)
...
Cohesion: 0.17
Nodes (13): aj(), bD(), CJ(), createInventory(), Fi(), getActive(), getInfo(), list() (+5 more)

### Community 126 - "Community 126"
Cohesion: 0.22
Nodes (13): Aq(), Do(), F$(), fq(), gA(), getPropagationContext(), hA(), iq() (+5 more)

### Community 127 - "Community 127"
Cohesion: 0.19
Nodes (13): a(), Ah(), fH(), hH(), jm(), Jn(), pH(), rU() (+5 more)
...
Cohesion: 0.33
Nodes (12): Fg(), Gg(), hg(), jy(), Ly(), pI(), _popScope(), qr() (+4 more)
...
Cohesion: 0.31
Nodes (11): CW(), fs(), G$(), hI(), isValueSettableForElement(), JP(), qg(), targetForElement() (+3 more)

### Community 145 - "Community 145"
Cohesion: 0.31
Nodes (11): Dl(), eD(), hy(), kt(), mt(), mv(), oX(), pv() (+3 more)
...
Cohesion: 0.22
Nodes (10): clone(), eX(), fB(), Gz(), mD(), rz(), tf(), update() (+2 more)

### Community 152 - "Community 152"
Cohesion: 0.22
Nodes (10): aW(), cI(), dD(), iX(), kd(), maybeAutoAnswerBrowserUseRequest(), sW(), Sx() (+2 more)
...
Cohesion: 0.25
Nodes (9): aM(), Gj(), handleData(), handleMessage(), jX(), nj(), Rj(), vj() (+1 more)

### Community 158 - "Community 158"
Cohesion: 0.47
Nodes (9): _checkInitializationStatus(), _checkUserHasIdForEvaluation(), $emt(), _enqueueExposure(), _getDynamicConfigImpl(), _getExperimentImpl(), getExposureMapping(), _getFeatureGateImpl() (+1 more)

### Community 159 - "Community 159"
Cohesion: 0.25
Nodes (9): activeRetiredInternalScreencastSessions(), captureSessions(), enableAccessibility(), isCurrentInternalScreencastEvent(), isInternalScreencastEvent(), retireInternalScreencast(), targetIdForFrame(), yp() (+1 more)

### Community 160 - "Community 160"
Cohesion: 0.22
Nodes (9): #e(), hf(), identityForElement(), jV(), Qo(), runExclusive(), u1(), Wy() (+1 more)
...
Cohesion: 0.44
Nodes (9): getFileTransferPermission(), getFullCdpPermission(), getOriginPermission(), gs(), handleFileTransferPromptResult(), handleFullCdpPromptResult(), handleOriginPromptResult(), hs() (+1 more)

### Community 163 - "Community 163"
Cohesion: 0.25
Nodes (9): aA(), bA(), ei(), fA(), G3(), HL(), k3(), NA() (+1 more)
...
Cohesion: 0.33
Nodes (9): clickDomCuaNode(), d0(), Eo(), iO(), kz(), sZ(), tO(), $U() (+1 more)
...
Cohesion: 0.4
Nodes (5): handleIncomingMessage(), handleIncomingRequest(), sendMessage(), sendNotification(), Su()
...
Cohesion: 0.5
Nodes (4): Ci(), elementInfo(), elementScreenshot(), isFinite()

### Community 201 - "Community 201"
Cohesion: 0.5
Nodes (4): brand(), default(), me(), transform()

### Community 202 - "Community 202"
Cohesion: 0.5
Nodes (4): allowDownload(), waitForCompletedDownload(), waitForDownload(), waitForDownloadRequest()
...
Cohesion: 0.67
Nodes (4): aborted(), explicitlyAborted(), handleCanaryResult(), runChecks()
...
## Knowledge Gaps
- **728 isolated node(s):** `Application configuration loaded from environment variables.`, `Parse comma-separated CORS origins into a list.`, `Resolve knowledge_base_dir relative to backend/ root.`, `Extract the host portion from supabase_url (e.g. tesfafbkhbleipxbpcpk).`, `Async PostgreSQL connection string for SQLAlchemy (asyncpg).` (+723 more)
...
- **Why does `counter()` connect `Community 71` to `Community 0`, `Community 140`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 140` to `Community 4`, `Community 71`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 71` to `Community 4`?**
