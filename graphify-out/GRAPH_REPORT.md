...
## Corpus Check
- 224 files · ~4,050,721 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4943 nodes · 13593 edges · 336 communities (258 shown, 78 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 832 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8ee34e59`
...
7. `parse()` - 73 edges
8. `create()` - 60 edges
9. `ProductSkillResolver` - 59 edges
10. `filter()` - 59 edges

## Surprising Connections (you probably didn't know these)
- `run_test()` --calls--> `handle_customer_ws()`  [INFERRED]
  test_debug.py → backend/app/websocket/chat_handler.py
- `run_test()` --calls--> `TicketLifecycleResult`  [INFERRED]
  test_debug.py → backend/app/tickets/lifecycle.py
...
## Communities (336 total, 78 thin omitted)
...
Cohesion: 0.02
Nodes (196): _$(), $4(), _5(), $8(), A4(), a5(), a7(), a8() (+188 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (178): abort(), assert(), Au(), bd(), Bl(), bp(), brand(), Bu() (+170 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (119): _array(), _base64(), base642(), _base64url(), base64url2(), _bigint(), bigint2(), bigint3() (+111 more)
...
Cohesion: 0.05
Nodes (76): accept(), all(), allTextContents(), and(), args(), array(), back(), browserAuthSelector() (+68 more)

### Community 6 - "Community 6"
Cohesion: 0.05
Nodes (74): adjustForFailure(), adjustForSuccess(), _attemptScheduledFlush(), batchSize(), cachedBlocked(), _capture(), captureCandidate(), catch() (+66 more)
...
Cohesion: 0.08
Nodes (63): aA(), Aq(), bA(), Be(), browserName(), bt(), ca(), da() (+55 more)

### Community 9 - "Community 9"
Cohesion: 0.05
Nodes (58): addEvent(), addToPendingEventsQueue(), appendAndResetNonExposedChecks(), call(), _checkInitializationStatus(), checkQuickFlush(), _checkUserHasIdForEvaluation(), clickDomCuaNode() (+50 more)
...
Cohesion: 0.07
Nodes (53): attachErrorIfNoneExists(), _createErrorUpdateDetails(), _extractBootstrapMetadata(), _fetchAndPrepFromNetwork(), finalize(), _finalizeUpdate(), _getCacheKey(), getConfig() (+45 more)

### Community 13 - "Community 13"
Cohesion: 0.07
Nodes (37): ExtractionSource, OrderStatus, Pydantic schemas for API request/response validation., RouterFailureType, Sentiment, TargetAgentState, TicketPriority, TicketStatus (+29 more)

### Community 14 - "Community 14"
Cohesion: 0.12
Nodes (35): ProductAgentResponse, Structured response produced by ProductAgent., Structured response produced by ProductAgent., Structured response produced by ProductAgent., Structured response produced by ProductAgent., RiskLevel, SkillExecutionStatus, SkillDefinition (+27 more)

### Community 15 - "Community 15"
Cohesion: 0.08
Nodes (49): actionError(), allTextContents(), and(), args(), cachedRead(), check(), clear(), click() (+41 more)

### Community 16 - "Community 16"
Cohesion: 0.05
Nodes (41): LLMAdapter, ProductAgent, Product Agent (Phase D.1)  Owns product-domain reasoning. Receives semantic cont, Domain agent for the Product vertical.      Responsibilities:     - Receive prod, Domain agent for the Product vertical.      Responsibilities:     - Receive prod, Domain agent for the Product vertical.      Responsibilities:     - Receive prod, Domain agent for the Product vertical.      Responsibilities:     - Receive prod, Domain agent for the Product vertical.      Responsibilities:     - Receive prod (+33 more)
...
Cohesion: 0.1
Nodes (42): callCdpTarget(), callRuntimeEvaluateInExecutionTarget(), callRuntimeEvaluateWithPlaywrightInjectedInTarget(), deletePlaywrightFrameWorld(), ds(), ensurePlaywrightInjectedInTarget(), evaluateOnPlaywrightSelectorWithTarget(), evaluateSelectorAllInTarget() (+34 more)

### Community 20 - "Community 20"
Cohesion: 0.08
Nodes (43): bg(), bq(), browserAuthSelector(), Dg(), Dn(), ef(), ei(), F$() (+35 more)

### Community 21 - "Community 21"
Cohesion: 0.06
Nodes (42): a(), bundle(), _c(), content(), dc(), dirty(), ea(), f() (+34 more)

### Community 22 - "Community 22"
Cohesion: 0.06
Nodes (42): add(), addCloseListener(), addTabAttachHandler(), aW(), C3(), captureSessions(), cD(), cx() (+34 more)
...
Cohesion: 0.06
Nodes (38): cancel_order(), get_chat_history(), get_customer_by_id(), get_customer_history(), get_ticket(), process_refund(), Database Tools — Supabase operations that power both the MCP server and the Fast, Get past chat conversations for a customer. (+30 more)

### Community 27 - "Community 27"
Cohesion: 0.07
Nodes (39): _addCheck(), append(), base64(), base64url(), bte(), cidr(), cuid(), cuid2() (+31 more)

### Community 28 - "Community 28"
Cohesion: 0.05
Nodes (37): AgentState, create_customer_support_graph(), db_plan_node(), escalation_node(), rag_node(), LangGraph Orchestration — wires all agent nodes together into a state graph. Al, Node: Answers questions using Pinecone knowledge base., Node: Determines DB action. If high-risk, pauses for approval. (+29 more)
...
Cohesion: 0.09
Nodes (34): aj(), allowBeforeUnload(), attachedTabIdForCdpEvent(), Av(), callInputDispatch(), clickLocator(), deleteJsDialogForTarget(), dispatchKeyPress() (+26 more)

### Community 35 - "Community 35"
Cohesion: 0.07
Nodes (32): TicketCreate, TicketResponse, TicketUpdate, admin_reingest_kb(), admin_update_llm_settings(), cancel_order_endpoint(), create_new_ticket(), customer_history() (+24 more)

### Community 36 - "Community 36"
Cohesion: 0.09
Nodes (32): beacon(), EP(), error(), getActiveFallbackUrl(), getChecksum(), _getInternalRequestArgs(), _getPopulatedURL(), _getRequestData() (+24 more)

### Community 37 - "Community 37"
Cohesion: 0.07
Nodes (25): list_customers(), Get all customers with pagination., get_all_customers(), Get all customers with pagination., Get all customers with pagination., Get all customers with pagination., Get all customers with pagination., Get all customers with pagination. (+17 more)
...
Cohesion: 0.07
Nodes (21): Integration tests for Supabase database tools.  Tests customer lookup, order t, Track an order that exists in the database., Track an order that exists in the database., Tracking a non-existent order returns error., Tracking a non-existent order returns error., Test ticket creation and updates., Test that invalid enums are rejected., Test that invalid enums are rejected in updates. (+13 more)
...
Cohesion: 0.1
Nodes (26): addAttachment(), addScopeListener(), dH(), enableDownload(), Gx(), handleData(), jh(), jm() (+18 more)
...
Cohesion: 0.09
Nodes (25): b3(), Bi(), complete(), #e(), evaluateOnPlaywrightPage(), evaluateWithPlaywrightInjected(), evaluateWithPlaywrightInjectedInTarget(), _h() (+17 more)

### Community 55 - "Community 55"
Cohesion: 0.11
Nodes (25): a1(), bL(), e6(), EM(), endsWith(), gv(), i1(), J3() (+17 more)

### Community 56 - "Community 56"
Cohesion: 0.12
Nodes (25): deleteFrameSession(), detachAttachedFrameTargets(), documentation(), ensureRuntimeEnabled(), g7(), get(), getPath(), H1() (+17 more)

### Community 57 - "Community 57"
Cohesion: 0.2
Nodes (21): check_warranty_status(), Deterministically check warranty status for a customer's purchase., Deterministically check warranty status for a customer's purchase., Deterministically check warranty status for a customer's purchase., Deterministically check warranty status for a customer's purchase., build_mock_order(), create_mock_supabase(), Phase E.1 — Warranty Capability Tests  Tests check_warranty_status deterministic (+13 more)
...
Cohesion: 0.11
Nodes (24): addEventListener(), addListener(), addTabCleanupHandler(), AL(), cee(), constructor(), createNamespace(), fO() (+16 more)
...
Cohesion: 0.09
Nodes (21): _execute_tool(), Execute a database tool by name, injecting the authenticated customer_id securel, Execute a database tool by name, injecting the authenticated customer_id securel, Execute a database tool by name, injecting the authenticated customer_id securel, Execute a database tool by name, injecting the authenticated customer_id securel, Execute a database tool by name, injecting the authenticated customer_id securel, Execute a database tool by name, injecting the authenticated customer_id securel, Send an email to the customer with an update regarding their ticket. (+13 more)

### Community 62 - "Community 62"
Cohesion: 0.12
Nodes (17): CustomerProfile, ExtractedEntity, SkillExecutionResult, BaseModel, CustomerContext, Expected, GoldenDataset, GoldenExample (+9 more)

### Community 63 - "Community 63"
Cohesion: 0.1
Nodes (18): RAGAS RAG Evaluation Tests — measures faithfulness, relevancy, context precisio, Live tests that validate RAG response quality with the actual LLM., For questions outside the KB, the RAG should gracefully refuse., Full RAGAS evaluation. Run with RUN_RAGAS_EVAL=1., Run RAGAS evaluation and check metric thresholds., Tests that the Pinecone retriever returns relevant chunks., test_retriever_relevance_scores(), test_retriever_returns_relevant_source() (+10 more)

### Community 64 - "Community 64"
Cohesion: 0.14
Nodes (23): A6(), aI(), C6(), dirty(), _getInvalidInput(), _getOrReturnCtx(), _getType(), implement() (+15 more)

### Community 65 - "Community 65"
Cohesion: 0.15
Nodes (23): at(), attach(), attachDebuggerFrameTarget(), closeTab(), Dp(), e1(), enableFocusEmulation(), enableOopifAutoAttach() (+15 more)

### Community 66 - "Community 66"
Cohesion: 0.12
Nodes (23): addToNumericResult(), array(), configureAndConnect(), connect(), emitNamedEntityData(), emitNotTerminatedNamedEntity(), emitNumericEntity(), end() (+15 more)

### Community 67 - "Community 67"
Cohesion: 0.09
Nodes (21): cancel_order(), check_inventory(), create_ticket(), get_customer_history(), get_dashboard_stats(), get_ticket(), lookup_customer(), process_refund() (+13 more)

### Community 68 - "Community 68"
Cohesion: 0.1
Nodes (19): list_tickets(), Get all tickets with optional status filter., get_all_tickets(), Get all tickets with optional status filter., Get all tickets with optional status filter., Get all tickets with optional status filter., Get all tickets with optional status filter., Get all tickets with optional status filter. (+11 more)

### Community 69 - "Community 69"
Cohesion: 0.13
Nodes (22): BW(), cm(), cY(), dm(), dW(), eb(), fW(), getBrowsers() (+14 more)

### Community 70 - "Community 70"
Cohesion: 0.1
Nodes (22): An(), cn(), currentPointInParentFrame(), currentTopLevelPointForAction(), describeBackendNodeForHitTarget(), EJ(), ite(), Jg() (+14 more)
...
Cohesion: 0.1
Nodes (21): assertFullCdpEnabled(), deepPartial(), fA(), fetchBlocked(), _fetchFromNetwork(), fullCdpAccessState(), fv(), isFullCdpEnabled() (+13 more)

### Community 74 - "Community 74"
Cohesion: 0.2
Nodes (21): fetchEvaluations(), Fg(), fk(), G$(), Gg(), hg(), includes(), isValueSettableForElement() (+13 more)

### Community 75 - "Community 75"
Cohesion: 0.14
Nodes (21): AB(), Bo(), captureMessage(), ct(), eventFromException(), eventFromMessage(), fm(), gO() (+13 more)
...
Cohesion: 0.1
Nodes (15): GraphLLMAdapter, Conditional edge function to determine the next node., Conditional edge function to determine the next node., Conditional edge function to determine the next node., Conditional edge function to determine the next node., Conditional edge function to determine the next node., Conditional edge function to determine the next node., Conditional edge function to determine the next node. (+7 more)
...
Cohesion: 0.14
Nodes (19): bZ(), callTarget(), Cb(), dB(), E3(), eH(), eR(), fs() (+11 more)

### Community 86 - "Community 86"
Cohesion: 0.15
Nodes (19): CL(), currentSession(), DI(), EL(), getCurrentTurnId(), ie(), Ig(), needsReclaim() (+11 more)

### Community 87 - "Community 87"
Cohesion: 0.13
Nodes (19): a(), c(), ff(), format(), hasOwnedPausedResponses(), J_(), l(), n() (+11 more)
...
Cohesion: 0.12
Nodes (18): admin_get_kb_doc(), admin_list_kb(), List all knowledge base documents., Read a specific knowledge base document., get_knowledge_base_doc(), list_knowledge_base_docs(), List all knowledge base documents., List all knowledge base documents. (+10 more)
...
Cohesion: 0.18
Nodes (18): aD(), bU(), clearPlaywrightFrameWorldsForTarget(), clearPlaywrightStateForTarget(), dk(), handleCdpEvent(), id(), iK() (+10 more)
...
Cohesion: 0.15
Nodes (17): abort(), bv(), deleteJsDialog(), dv(), En(), ensurePlaywrightInjected(), gL(), hv() (+9 more)

### Community 99 - "Community 99"
Cohesion: 0.13
Nodes (17): bH(), ch(), F7(), Il(), isEmpty(), l7(), lx(), mH() (+9 more)

### Community 100 - "Community 100"
Cohesion: 0.18
Nodes (17): bB(), d0(), fB(), getSdkMetadata(), Gz(), iO(), js(), kz() (+9 more)

### Community 101 - "Community 101"
Cohesion: 0.18
Nodes (17): _clearOutcomes(), close(), emit(), flush(), _flushOutcomes(), gB(), h0(), _isClientDoneProcessing() (+9 more)
...
Cohesion: 0.17
Nodes (11): WarrantyStatusResult, _check_warranty_status_impl(), _parse_warranty_duration(), Deterministically parse warranty duration from product description., Deterministically parse warranty duration from product description., Deterministically parse warranty duration from product description., Internal implementation of warranty check with DB retries., Internal implementation of warranty check with DB retries. (+3 more)
...
Cohesion: 0.17
Nodes (16): closeWatcher(), discoverRolloutPath(), Fj(), hasActiveRollout(), isPathTracked(), lj(), processRollouts(), processSessionRollout() (+8 more)

### Community 107 - "Community 107"
Cohesion: 0.13
Nodes (16): CJ(), cre(), eW(), fn(), getInfo(), isWebMcpEnabled(), lre(), pg() (+8 more)

### Community 108 - "Community 108"
Cohesion: 0.15
Nodes (16): aK(), aX(), Bk(), CG(), ck(), _D(), eK(), getBackendNodeViewportPoint() (+8 more)
...
Cohesion: 0.25
Nodes (16): _0(), getTransport(), GR(), hU(), ks(), Lo(), mu(), Ne() (+8 more)
...
Cohesion: 0.19
Nodes (15): eq(), Fd(), gI(), Nd(), Od(), paramsForSelectedOption(), Rd(), revalidate() (+7 more)

### Community 115 - "Community 115"
Cohesion: 0.18
Nodes (15): assertCompatibleLocator(), assertRequiredDocumentationRead(), bundle(), Do(), exclude(), filter(), getAssets(), IM() (+7 more)
...
Cohesion: 0.26
Nodes (12): DBPlannerOutput, determine_db_action(), Determine which database action(s) to take based on the customer message and int, Determine which database action(s) to take based on the customer message and int, Determine which database action(s) to take based on the customer message and int, test_planner_cancel_active_order(), test_planner_check_inventory(), test_planner_malformed_output() (+4 more)
...
Cohesion: 0.16
Nodes (14): $1(), _7(), d3(), ec(), ez(), fU(), gH(), kp() (+6 more)

### Community 123 - "Community 123"
Cohesion: 0.19
Nodes (14): Aee(), continueResponse(), Cr(), _ee(), Fee(), handleEvent(), Hee(), Iee() (+6 more)
...
Cohesion: 0.17
Nodes (12): _extract_number(), generate_response(), get_db_llm(), Database / Memory Agent — handles customer-specific operations by querying the, Generate a response using database tool results.      Args:         message: The, Generate a response using database tool results.      Args:         message:, Extract a number following a prefix word (e.g., 'order 1234' -> 1234)., Extract a number following a prefix word (e.g., 'order 1234' -> 1234). (+4 more)
...
Cohesion: 0.23
Nodes (13): Ao(), captureEvent(), captureException(), CO(), I0(), JP(), _prepareEvent(), preprocessEvent() (+5 more)
...
Cohesion: 0.18
Nodes (12): ij(), IZ(), m0(), mM(), nM(), nQ(), rQ(), tq() (+4 more)

### Community 132 - "Community 132"
Cohesion: 0.18
Nodes (12): aM(), CU(), Gj(), handleMessage(), ni(), nj(), qL(), ri() (+4 more)
...
Cohesion: 0.27
Nodes (9): counter(), extract_field_instructions(), _field_type(), _iter_word_xml_parts(), main(), Extract field instructions from a WordprocessingML part.      Handles:     -, _has_numbering(), _heading_level() (+1 more)
...
Cohesion: 0.25
Nodes (11): all(), buildRevision(), captureAX(), captureDocuments(), captureJavaScriptDialog(), kk(), pk(), vk() (+3 more)

### Community 142 - "Community 142"
Cohesion: 0.27
Nodes (11): bM(), By(), c0(), gM(), Ns(), nZ(), Os(), oZ() (+3 more)

### Community 143 - "Community 143"
Cohesion: 0.22
Nodes (11): Ah(), fH(), Gn(), hH(), Jn(), JU(), tc(), toUpperCase() (+3 more)

### Community 144 - "Community 144"
Cohesion: 0.2
Nodes (11): bD(), createInventory(), ensure(), ensurePageClipboard(), Fi(), getActive(), install(), list() (+3 more)

### Community 145 - "Community 145"
Cohesion: 0.31
Nodes (11): a0(), captureCheckIn(), cte(), getDsn(), getOptions(), Hm(), isEnabled(), RB() (+3 more)

### Community 146 - "Community 146"
Cohesion: 0.22
Nodes (11): Az(), b(), captureSession(), dU(), getEventProcessors(), jB(), m(), tZ() (+3 more)
...
Cohesion: 0.24
Nodes (10): Bn(), getScopeData(), Hn(), kB(), setSDKProcessingMetadata(), Vf(), vte(), Ws() (+2 more)

### Community 152 - "Community 152"
Cohesion: 0.31
Nodes (10): getIsolationScope(), getSession(), gU(), Mz(), qM(), setSession(), setupOnce(), toContext() (+2 more)

### Community 153 - "Community 153"
Cohesion: 0.31
Nodes (10): dispatchMouseDown(), eV(), fr(), py(), QP(), Qz(), setLiveValues(), tP() (+2 more)

### Community 154 - "Community 154"
Cohesion: 0.24
Nodes (10): addBreadcrumb(), cz(), dz(), Et(), Pz(), Qb(), recordDroppedEvent(), Rs() (+2 more)
...
Cohesion: 0.44
Nodes (8): _extract_intent_from_subject(), _find_matching_ticket(), _get_issue_identity(), _is_compatible_identity(), _is_compatible_intent(), _map_to_priority(), _map_to_ticket_type(), process_issue()

### Community 158 - "Community 158"
Cohesion: 0.22
Nodes (9): cI(), evaluateOnPlaywrightSelector(), Kf(), qf(), readCheckedState(), sW(), _v(), xA() (+1 more)

### Community 159 - "Community 159"
Cohesion: 0.22
Nodes (9): ere(), g0(), Gf(), jte(), kl(), qU(), setClient(), setPropagationContext() (+1 more)

### Community 160 - "Community 160"
Cohesion: 0.22
Nodes (9): addEventProcessor(), e0(), fz(), kM(), Kn(), oO(), Ry(), v7() (+1 more)

### Community 161 - "Community 161"
Cohesion: 0.25
Nodes (9): allowDownload(), disableDownload(), failPendingDownloadRequest(), failResponse(), handleDownloadResponse(), removeEnabledTab(), waitForCompletedDownload(), waitForDownload() (+1 more)
...
Cohesion: 0.25
Nodes (8): BX(), dx(), fX(), mX(), Px(), Rh(), setUser(), VU()
...
Cohesion: 0.29
Nodes (7): Ag(), clearPollingTimer(), dispose(), _getFirstCachedFrame(), rejectPendingRequests(), removeListener(), values()

### Community 173 - "Community 173"
Cohesion: 0.29
Nodes (7): As(), Dy(), evaluateOnPlaywrightSelectorAll(), Is(), readElementState(), ut(), xq()

### Community 174 - "Community 174"
Cohesion: 0.33
Nodes (7): activeJsDialog(), CW(), hI(), qg(), sk(), updateJsDialogPrompt(), Yg()

### Community 175 - "Community 175"
Cohesion: 0.33
Nodes (7): AP(), evaluateJavascript(), FL(), mj(), rP(), wv(), yv()
...
Cohesion: 0.33
Nodes (5): Map a semantic intent to a Product-domain skill using explicit mappings only., Map a semantic intent to a Product-domain skill using explicit mappings only., Map a semantic intent to a Product-domain skill using explicit mappings only., Map a semantic intent to a Product-domain skill using explicit mappings only., Deterministic mapping from semantic intent to Product skill.         Returns Non
...
Cohesion: 0.33
Nodes (6): currentTopLevelUrl(), k7(), keyof(), Kx(), LW(), uw()

### Community 183 - "Community 183"
Cohesion: 0.53
Nodes (6): hK(), om(), rn(), TM(), tW(), wk()

### Community 184 - "Community 184"
Cohesion: 0.4
Nodes (6): clone(), getClient(), getScope(), getStackTop(), _pushScope(), rz()

### Community 185 - "Community 185"
Cohesion: 0.33
Nodes (6): focusLocator(), $i(), Kee(), Kte(), nN(), remove()
...
Cohesion: 0.4
Nodes (5): fetchLiveEvaluations(), getContext(), getLiveCursor(), getValues(), _refreshLiveValuesAsyncImpl()
...
Cohesion: 0.5
Nodes (4): EscalationAlert, Sent to the Agent Dashboard when a customer is escalated., Sent to the Agent Dashboard when a customer is escalated., Sent to the Agent Dashboard when a customer is escalated.
...
Cohesion: 0.5
Nodes (4): getPropagationContext(), l0(), Lu(), sq()
...
## Knowledge Gaps
- **720 isolated node(s):** `Application configuration loaded from environment variables.`, `Parse comma-separated CORS origins into a list.`, `Resolve knowledge_base_dir relative to backend/ root.`, `Extract the host portion from supabase_url (e.g. tesfafbkhbleipxbpcpk).`, `Async PostgreSQL connection string for SQLAlchemy (asyncpg).` (+715 more)
...
- **Why does `counter()` connect `Community 139` to `Community 0`, `Community 137`, `Community 181`, `Community 191`?**
  _High betweenness centrality (0.063) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 137` to `Community 139`, `Community 13`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 181` to `Community 139`, `Community 13`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Are the 122 inferred relationships involving `str` (e.g. with `run_test()` and `test_handover()`) actually correct?**
