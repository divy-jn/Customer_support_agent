...
## Corpus Check
- 224 files · ~4,052,836 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4953 nodes · 13607 edges · 341 communities (258 shown, 83 thin omitted)
- Extraction: 94% EXTRACTED · 6% INFERRED · 0% AMBIGUOUS · INFERRED: 841 edges (avg confidence: 0.7)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `7cb5a5c9`
...
## Communities (341 total, 83 thin omitted)
...
Cohesion: 0.02
Nodes (206): _$(), $4(), _5(), $8(), A4(), a5(), a7(), a8() (+198 more)
...
Cohesion: 0.05
Nodes (74): _0(), Bn(), bq(), captureSession(), clone(), Dn(), ef(), EL() (+66 more)
...
Cohesion: 0.05
Nodes (71): accept(), allTextContents(), and(), args(), array(), back(), browserAuthSelector(), cachedRead() (+63 more)
...
Cohesion: 0.06
Nodes (60): Ag(), buildRevision(), _capture(), captureAX(), captureCandidate(), captureDocuments(), captureJavaScriptDialog(), catch() (+52 more)
...
Cohesion: 0.05
Nodes (56): addEventListener(), addListener(), addTabCleanupHandler(), AL(), bM(), By(), c0(), cee() (+48 more)
...
Cohesion: 0.06
Nodes (47): add(), addCloseListener(), addTabAttachHandler(), attach(), callTarget(), captureSessions(), closeTab(), Dp() (+39 more)
...
Cohesion: 0.07
Nodes (45): adjustForFailure(), adjustForSuccess(), attachErrorIfNoneExists(), _attemptScheduledFlush(), batchSize(), _clearAllTimers(), containsAtLeastOneFullBatch(), convertPendingEventsToBatches() (+37 more)
...
Cohesion: 0.07
Nodes (30): check_inventory(), lookup_customer(), Database Tools — Supabase operations that power both the MCP server and the Fast, Check if a specific product is in stock and get its details., Check if a specific product is in stock and get its details., Check if a specific product is in stock and get its details., Check if a specific product is in stock and get its details., Check if a specific product is in stock and get its details. (+22 more)
...
Cohesion: 0.09
Nodes (31): $1(), _7(), addToNumericResult(), array(), Cs(), emitNamedEntityData(), emitNotTerminatedNamedEntity(), emitNumericEntity() (+23 more)
...
Cohesion: 0.08
Nodes (29): cancel_order(), get_customer_history(), get_ticket(), process_refund(), Get details of a specific ticket, including updates., Get details of a specific ticket, including updates., Get details of a specific ticket, including updates., Track the current status and delivery information of an order. (+21 more)
...
Cohesion: 0.11
Nodes (28): A6(), aI(), C6(), dirty(), _getCached(), _getInvalidInput(), _getOrReturnCtx(), _getType() (+20 more)
...
Cohesion: 0.11
Nodes (25): activeRetiredInternalScreencastSessions(), detachAttachedFrameTargets(), documentation(), ensureRuntimeEnabled(), focusLocator(), g7(), get(), getPath() (+17 more)
...
Cohesion: 0.11
Nodes (24): addEvent(), addToPendingEventsQueue(), appendAndResetNonExposedChecks(), checkQuickFlush(), debug(), enqueue(), _getCurrentPageUrl(), _getEventsFromStorage() (+16 more)

### Community 59 - "Community 59"
Cohesion: 0.08
Nodes (24): allowDownload(), attachTarget(), claimTab(), claimUserTab(), createTab(), detach(), detachTab(), detachTarget() (+16 more)
...
Cohesion: 0.09
Nodes (22): _addCheck(), base64(), base64url(), cidr(), cuid(), cuid2(), date(), datetime() (+14 more)

### Community 62 - "Community 62"
Cohesion: 0.1
Nodes (22): CJ(), cn(), EJ(), getInfo(), gO(), Hee(), hO(), ite() (+14 more)
...
Cohesion: 0.1
Nodes (21): A9(), BW(), cI(), E9(), eb(), _enqueueDiagnosticsEvent(), evaluateOnPlaywrightSelector(), G9() (+13 more)
...
Cohesion: 0.14
Nodes (20): beacon(), dH(), EP(), _getPopulatedURL(), _getRequestData(), getUrl(), ip(), Ir() (+12 more)
...
Cohesion: 0.15
Nodes (19): a1(), append(), at(), attachDebuggerFrameTarget(), e1(), executeTargetCdp(), GP(), handleFrameNavigated() (+11 more)
...
Cohesion: 0.11
Nodes (18): _execute_tool(), Execute a database tool by name, injecting the authenticated customer_id securel, Execute a database tool by name, injecting the authenticated customer_id securel, Execute a database tool by name, injecting the authenticated customer_id securel, Execute a database tool by name, injecting the authenticated customer_id securel, Execute a database tool by name, injecting the authenticated customer_id securel, Execute a database tool by name, injecting the authenticated customer_id securel, get_chat_history() (+10 more)
...
Cohesion: 0.17
Nodes (18): bg(), browserAuthSelector(), Dg(), FL(), hW(), l0(), Lu(), max() (+10 more)

### Community 86 - "Community 86"
Cohesion: 0.15
Nodes (18): eV(), fr(), getConfigList(), _getConfigListImpl(), _getLiveDetails(), Hz(), iy(), oy() (+10 more)
...
Cohesion: 0.12
Nodes (18): aM(), CU(), Gj(), handleIncomingMessage(), handleIncomingRequest(), handleMessage(), ij(), nj() (+10 more)
...
Cohesion: 0.14
Nodes (17): bD(), createInventory(), ensure(), Fi(), getActive(), getBrowsers(), getForUrl(), getTabs() (+9 more)

### Community 94 - "Community 94"
Cohesion: 0.19
Nodes (17): Av(), callInputDispatch(), clickLocator(), down(), insertText(), Jf(), Jt(), keyText() (+9 more)

### Community 95 - "Community 95"
Cohesion: 0.18
Nodes (17): a0(), bB(), CO(), cte(), ff(), getDsn(), getOptions(), getSdkMetadata() (+9 more)
...
Cohesion: 0.12
Nodes (17): cv(), Gn(), hr(), hte(), JU(), Kf(), Kn(), lv() (+9 more)
...
Cohesion: 0.17
Nodes (16): bte(), fq(), fte(), gt(), gte(), In(), lt(), lte() (+8 more)
...
Cohesion: 0.15
Nodes (15): clearPlaywrightFrameWorldsForTarget(), clearPlaywrightStateForTarget(), _configureUser(), dk(), E3(), ft(), keys(), lee() (+7 more)

### Community 105 - "Community 105"
Cohesion: 0.19
Nodes (15): bL(), CL(), e6(), EM(), gL(), og(), ov(), ra() (+7 more)

### Community 106 - "Community 106"
Cohesion: 0.19
Nodes (15): bU(), eW(), handleCdpEvent(), iK(), isDownload(), Ok(), pushLog(), readBytes() (+7 more)

### Community 107 - "Community 107"
Cohesion: 0.2
Nodes (15): all(), Fd(), gI(), install(), NW(), Od(), paramsForSelectedOption(), revalidate() (+7 more)

### Community 108 - "Community 108"
Cohesion: 0.17
Nodes (15): callRawCdp(), clickDomCuaNode(), clickPoint(), dispatchCdpMouseMove(), dispatchCdpMouseRelease(), dispatchMouseDown(), dispatchMouseMove(), dispatchMouseUp() (+7 more)

### Community 109 - "Community 109"
Cohesion: 0.21
Nodes (15): AB(), Bo(), captureCheckIn(), captureMessage(), ct(), eventFromException(), eventFromMessage(), IB() (+7 more)
...
Cohesion: 0.23
Nodes (14): aX(), currentSession(), getCurrentTurnId(), ie(), jk(), kk(), needsReclaim(), nextRawCdpEventSequence() (+6 more)

### Community 118 - "Community 118"
Cohesion: 0.19
Nodes (14): deepPartial(), Hn(), iI(), Jq(), lI(), mg(), qq(), r5() (+6 more)

### Community 119 - "Community 119"
Cohesion: 0.2
Nodes (14): C3(), cm(), cx(), _D(), dD(), getDefault(), ic(), iX() (+6 more)
...
Cohesion: 0.26
Nodes (13): evaluateJavascript(), Gg(), gk(), hK(), om(), qr(), sk(), TM() (+5 more)

### Community 123 - "Community 123"
Cohesion: 0.32
Nodes (13): fetchEvaluations(), Fg(), fk(), G$(), hg(), includes(), isValueSettableForElement(), jy() (+5 more)

### Community 124 - "Community 124"
Cohesion: 0.18
Nodes (13): Bk(), bZ(), Cb(), dB(), eH(), eR(), fs(), Nk() (+5 more)

### Community 125 - "Community 125"
Cohesion: 0.17
Nodes (13): AP(), deleteFrameSession(), fn(), handleAttachedToTarget(), handleDetachedFromTarget(), handleFrameDetached(), handleTargetEvent(), isWebMcpEnabled() (+5 more)

### Community 126 - "Community 126"
Cohesion: 0.19
Nodes (13): Aee(), Cr(), d3(), _ee(), ez(), Fee(), Iee(), k() (+5 more)

### Community 127 - "Community 127"
Cohesion: 0.18
Nodes (13): addBreadcrumb(), As(), cz(), dz(), Et(), Is(), m0(), nQ() (+5 more)
...
Cohesion: 0.26
Nodes (12): aj(), Dl(), eD(), hy(), kt(), mt(), mv(), oX() (+4 more)

### Community 133 - "Community 133"
Cohesion: 0.2
Nodes (12): assertCompatibleLocator(), assertRequiredDocumentationRead(), bundle(), cD(), exclude(), filter(), getAssets(), pW() (+4 more)

### Community 134 - "Community 134"
Cohesion: 0.2
Nodes (12): ch(), getActiveFallbackUrl(), getChecksum(), _getInternalRequestArgs(), Ld(), lx(), O9(), sh() (+4 more)

### Community 135 - "Community 135"
Cohesion: 0.17
Nodes (12): Au(), Iu(), IZ(), Mk(), mM(), p0(), toJSON(), uZ() (+4 more)

### Community 136 - "Community 136"
Cohesion: 0.2
Nodes (12): abort(), bv(), deleteJsDialog(), dv(), En(), gv(), hv(), J_() (+4 more)

### Community 137 - "Community 137"
Cohesion: 0.21
Nodes (12): currentTopLevelUrl(), ensurePlaywrightInjected(), fW(), isFinite(), k7(), keyof(), Kx(), LW() (+4 more)

### Community 138 - "Community 138"
Cohesion: 0.18
Nodes (12): format(), n(), o(), Ree(), _runExecutor(), See(), _unrollOther(), url() (+4 more)
...
Cohesion: 0.27
Nodes (10): aD(), call(), ck(), continueResponse(), ensureInterceptionReady(), getBackendNodeViewportPoint(), handleEvent(), lk() (+2 more)
...
Cohesion: 0.31
Nodes (9): activeJsDialog(), F$(), gA(), JA(), kA(), mW(), qg(), updateJsDialogPrompt() (+1 more)

### Community 157 - "Community 157"
Cohesion: 0.25
Nodes (9): fX(), Gx(), kh(), mX(), OW(), Px(), S6(), uw() (+1 more)

### Community 158 - "Community 158"
Cohesion: 0.28
Nodes (9): aW(), cY(), dispatchKeyPress(), dW(), Mi(), Nd(), nX(), SY() (+1 more)

### Community 159 - "Community 159"
Cohesion: 0.25
Nodes (9): Az(), b(), c(), dU(), getEventProcessors(), jB(), m(), tZ() (+1 more)
...
Cohesion: 0.25
Nodes (8): cre(), fv(), kd(), lre(), Wn(), xL(), yN(), zD()

### Community 166 - "Community 166"
Cohesion: 0.25
Nodes (8): i1(), kv(), l1(), qL(), rU(), toUpperCase(), tU(), xV()
...
Cohesion: 0.33
Nodes (7): endsWith(), logError(), N9(), _pickNewFallbackUrl(), Qj(), _tryFetchFallbackUrlsFromNetwork(), tryFetchUpdatedFallbackInfo()

### Community 175 - "Community 175"
Cohesion: 0.33
Nodes (7): aK(), disableDownload(), eK(), failPendingDownloadRequest(), failResponse(), handleDownloadResponse(), removeEnabledTab()

### Community 176 - "Community 176"
Cohesion: 0.29
Nodes (7): assertFullCdpEnabled(), fullCdpAccessState(), isFullCdpEnabled(), J3(), Q3(), R_(), zn()

### Community 177 - "Community 177"
Cohesion: 0.43
Nodes (7): Ah(), fH(), hH(), Jn(), pH(), ve(), wh()

### Community 178 - "Community 178"
Cohesion: 0.43
Nodes (7): d0(), iO(), kz(), sZ(), tO(), $U(), Xe()
...
Cohesion: 0.4
Nodes (6): cachedBlocked(), DI(), Ig(), isBlocked(), r9(), throwIfBlocksUrl()

### Community 184 - "Community 184"
Cohesion: 0.33
Nodes (6): eq(), id(), Rd(), revalidateBeforeSubmit(), ug(), vW()

### Community 185 - "Community 185"
Cohesion: 0.4
Nodes (6): dm(), Do(), JW(), Pm(), preferredWindowIdFor(), zj()

### Community 186 - "Community 186"
Cohesion: 0.53
Nodes (6): IM(), ko(), Rm(), Ss(), vB(), xs()

### Community 187 - "Community 187"
Cohesion: 0.33
Nodes (6): nM(), Q_(), qn(), readFile(), rQ(), tq()
...
Cohesion: 0.5
Nodes (5): CW(), hI(), Jg(), Yg(), Zg()

### Community 194 - "Community 194"
Cohesion: 0.5
Nodes (5): fB(), Gz(), tf(), Wr(), x0()

### Community 195 - "Community 195"
Cohesion: 0.5
Nodes (5): _extractBootstrapMetadata(), _resetLiveValues(), _seedLiveValues(), setValues(), _setWarningState()
...
- **Why does `counter()` connect `Community 11` to `Community 0`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `main()` connect `Community 11` to `Community 6`?**
